...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
 ...
 <h4 class="btn btn-primary" style="font-size:25px; background-color:#a21a37;;width:1617px; border-radius:20px;"> <b class="fa fa-monesy" style="color:white;">&nbsp;&nbsp;Passed</b></h4>
...
$connection=mysqli_connect('localhost','root','','srms');
          ...
          $cate=$row['Jobtitle'];
 ;        
                    $count_query = mysqli_query($connection,"select * from postingsenderpassed where Jobtitle='$cate'") or die(mysqli_error());        
        ...
        <td width="140" style="text-align:center; width:15%;">
                <a  rel="tooltip"  title="View" id="v<?php echo $id; ?>"  href="onginternalpassed.php?id=<?php echo $row['Jobtitle'];?>" class="btn btn-primary button button4">View Applicant Passed/CV<?php echo $row7[classname];?>&nbsp;<i class="icon-list icon-large"></i></a>
           </td>
      </tr>
      <?php } ?>
                                </tbody>
