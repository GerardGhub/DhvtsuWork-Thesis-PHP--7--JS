...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
                    ...
                    <?php include('../includes/totheleftmessengerfriends.php');?>  
...
<div class="row">
      ...
      <div class="panel">
        <div class="panel-body">
          ...
          <div class="row">    
			...
			1	$query = $conn->query("select ongusers.id , ongusers.fname , ongusers.lastname , ongusers.user_image , friends.friends_id   from ongusers  , friends
	...
	?><div class="row">    
            <div class="col-md-2 text-center">
             <img  src="../item_images/userspics/<?php echo $friend_image; ?>" style="width:100px;height:100px" class="img-circle"></a>
            </div>
				<div class="col-md-10" style="display:noned">
					<div class="pull-right"><a href="#delete_friend.php<?php echo '?id='.$id; ?>" class="#btn btn-danger"><i class="icon-remove"></i> </a></div>
					<div class="alert"><?php echo $friend_name; ?><br><?php echo $department; ?></div>
