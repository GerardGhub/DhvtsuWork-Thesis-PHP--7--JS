...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
	   ...
	   <ul>
  <li style="float: left; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;"><a class="JRFREQUEST.php" href="JRFREQUEST.PHP" style="color:white;font-size:17px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home Current Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
  
  
  
  
  
  <li style="float: left;" class="active"><a href="JRFREQUEST2.php" style="color:white;font-size:17px; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job Request Done Completed&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
...
<div class="alert alert-primary" role="alert">
    ...
    <div class="#">
        ...
        ?>
		   ...
		   include('../connect.php');
		   $department =$_SESSION['department'];
               $query = mysql_query("Select * from Jobrequestcompleted where department='$department'") or die(mysql_error());
      ...
      <tr>
		...
		<?php echo $row['Type'];?>&nbsp;<?php echo $row['Typeothers'];?>
				 		      ...
				 		      <td class="zoom" style="text-align:center;font-size:12px;width:16%;">
		<?php echo $row['JobReq'];?>
				 </td>
				 		      <td class="zoom" style="text-align:center; font-size:12px;width:16%;">
		...
		<?php echo $row['MISOIC'];?>
				 				 			 		      ...
				 				 			 		      <td class="zoom <?php echo $row['Status'];?>" style="text-align:center;font-size:12px;">
		<?php echo $row['DH'];?>
				 </td>
				 			 		      <td class="zoom <?php echo $row['MISOIC'];?>" style="text-align:center;font-size:12px;">
...
<!-- href="view_equipment.php?id=<?php echo $item_id;?>" -->
  ...
  <!--a  rel="tooltip"  class="btn btn-primary" title="Job Request Proceed?" id="v<?php echo $id; ?>"  href="fixedasset_reportsticker.php?id<?php echo $item_category;?>" class="btn btn-light"><span class="glyphicon glyphicon-check" style="font-size:17px; color:white"></span></i></a-->
         ...
         <a rel="tooltip" class="btn btn-primary" title="Mark as a Pending?" id="<?php echo $id; ?>"  href="VIEWJRFCompleted.php?JRFseries=<?php echo $row['JRFseries']; ?>" data-toggle="modal"    class="btn btn-light"><span class="glyphicon glyphicon-eye-opesn" style="font-size:17px; color:white"></span>View<i class="icon-tr
