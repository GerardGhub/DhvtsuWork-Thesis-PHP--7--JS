...
?>
 ...
 <table border="0" align="left" class="borders" style="background-color:#f1f6f9;">
    ...
    <div class="col-sm-10">
   	  <input class="form-contrdol" type="text" name="item_name" value=":&nbsp;&nbsp;<?php echo $Two; ?>" style="border:none; font-size:18px; background-color:#f1f6f9;" readonly/>
    </div>
    ...
    <div class="col-sm-10">
   	  <input class="form-contsrol" type="text" name="item_name" value=":&nbsp;&nbsp;<?php echo $Fromo; ?>"style="border:none; font-size:18px; background-color:#f1f6f9;" readonly />
    </div>
    ...
    <div class="col-sm-10">
   	  <input class="form-contsrol" type="text" name="item_name" value=":&nbsp;&nbsp;<?php echo $Date; ?>" style="border:none; font-size:18px;background-color:#f1f6f9;" readonly />
    </div>
	
  			 
    <label for="inputPassword3" class="col-sm-2 control-label" style="color:black; font-size:18px; font-family:Verdana, Geneva, sans-serif; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Subject&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;</label>
    <div class="col-sm-10">
   	  <input class="form-controls" type="text" name="item_name" value=":&nbsp;&nbsp;<?php echo $subject;?>" style="border:none; font-size:18px;background-color:#f1f6f9;" readonly /><!--?php echo $Subject_Date; ?-->
    </div>
...
<?php
	   ...
	   include('connect.php');
		...
		<hr  width="85%" style="color:black;">
<p class="b"><emp style="font-size:17px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please be advised that below units are required to render overtime today <b><?php echo $Date;?></b><!--br--> this due to the &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;company's commitment to meet the shipment deadline to client.<!---b><?php echo $Employee;?></emp>
		...
		<br>
		<br>&nbsp;<emp style="font-size:17px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Any sudden changes on the said schedule, we will inform you immediately.</emp>
...
CUTTING FUR UNIT -<br>  
	...
	<td style="font-size:12px;" rowspan="8">
<b style="top:30px;">dsdsdsdsds</b>
<br>
...
TINTA UNIT- 8:00 PM<br> 
CUTTING FUR UNIT- 8:00 PM<br>  
CUTTING FUR UNIT -<br>  
		  ...
		  <div class="top-leftx"> <b style="font-size:17px;font-family:arial;">&#10146;TINTA UNIT- <?php echo $tinta;?><br>
										&#10146;CUTTING FUR UNIT- <?php echo $cuttingfur;?><br>
										&#10146;CUTTING LEATHER UNIT- <?php echo $cuttingleather;?><br>
										&#10146;FINISHING 1 UNIT- <?php echo $f1;?><br>
											&#10146;FINISHING 2 UNIT- <?php echo $f2;?><br>
									&#10146;FINISHING 3 UNIT- <?php echo $f3;?><br>
												&#10146;DECORATION UNIT- <?php echo $decoration;?><br>
												&#10146;RPD UNIT- <?php echo $rpd;?><br>
												&#10146;PATTERN SECTION- <?php echo $pattern;?><br>
												<br>
									&#10146;PRODN MAINTENANCE UNIT- <?php echo $prod_main;?></b><br><emp style="font-size:14px;"><center><pre style="border:none;font-size:14px;font-family:arial; background-color:#f1f6f9;"><?php echo $prod_maintenance;?></pre></center></emp>
										</div>
			  ...
			  <br>
			   <br> <br>
			    <br>
				 <br>
				  <br>
  <div class="top-rightx">&#10146;&nbsp;<b style="font-size:17px;">MANUFACTURING OFFICE- <?php echo $mftgoffice;?></b><br><emp style="font-size:14px;text-align:center;"><pre style="background-color:#f1f6f9;border:none;font-size:14px;font-family:arial;"><?php echo $Employee;?></pre></emp></div>
	
		<!---span>TINTA UNIT -<br> 
CUTTING FUR UNIT -<br>  
CUTTING LEATHER UNIT -<br>  
FINISHING 1 UNIT -<br>  
FINISHING 2 UNIT -<br>  
FINISHING 3 UNIT -<br>  		     
DECORATION UNIT -<br> 
RPD UNIT -<br>  
PATTERN SECTION -<br> </span>		s<span>sdfsfsfsfs</span-->
    ...
    <div class="col-sm-10">
	   ...
	   include('connect.php');
        ...
        ?>
		   ...
		   &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <b><emp style="font-size:17px;"><?php echo $Prepared_By;?></emp></b>
     <!--?php echo $row['position'];?--><p>
	     &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <emp style="font-size:15px;"><?php echo $_SESSION['sess_department'];?></emp>
    ...
    <!--select  class="form-control" id="inputPassword3" name="method" required/-->
	   ...
	   include('connect.php');
        ...
        ?>
		    ...
		    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <b><emp style="font-size:17px;"><?php echo $row['Name'];?></b></emp>
     <!--?php echo $row['position'];?--><p>
	     &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <emp style="font-size:15px;"><?php echo $row['position'];?></emp>
...
?>
    ...
    <tr>
	 ...
	 <!--div class="alert alert-default" style="background-color:#033c73;">
			...
			<footer style="font-size:12px; background-color:#f1f6f9; width:899px;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;Cc:&nbsp;&nbsp;<?php echo $cc1; ?><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cc2; ?><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cc3; ?><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cc4; ?><br>
