...
mysql_query("delete from Jobrequest where JRFse='$get_id'")or die(mysql_error());
?>
...
include('conface.php');
$id=$_GET['JRFseries'];
$query=mysql_query("select * from Jobrequestfinalpending where JRFseries='$id'") or die (mysql_error());
