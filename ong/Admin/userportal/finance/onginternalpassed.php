...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
   ...
   <!--h4 class="btn btn-primary" style="font-size:19px;">Fixed Asset File Manager
     ...
     <h4 class="btn btn-primary" style="font-size:25px; background-color:#337ab7; width:1617px;"> <b class="fa fa-read" style="color:white;">&nbsp;<b>INBOX PASSED</b> &nbsp;
...
<div class="alert alert-primary" role="alert">
   ...
   include('connect.php');
         ...
         $get_id=$_GET['id']; 
               $query = mysql_query("select * from postingsenderpassed where Jobtitle ='$get_id' ORDER by item_id DESC
			   ") or die(mysql_error());
