...
//	include('formatMoney.php');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		$item_category = $_POST['item_category'];
			...
			$acknowledgedby =$_POST['acknowledgedby'];
			$acknowledgeddate =$_POST['acknowledgeddate'];
			
			$gostaff =$_POST['gostaff'];
		...
		if(!isset($errMSG))
		{
			...
			$stmt->bindParam(':acknowledgeddate',$acknowledgeddate);
						$stmt->bindParam(':gostaff',$gostaff);
...
$savelisa = "INSERT INTO Jobrequestfinalactivity    (Date_now,Type,Name,Department,JobReq,Purpose,Preparedby,DH,JRFno,MISOIC,Status,pendingby,disapprovereasons,Activity,Activitydate)
SELECT Date_now,Type,Name,Department,JobReq,Purpose,Preparedby,DH,JRFno,MISOIC,Status,pendingby,disapprovereasons,Activity,Activitydate FROM Jobrequestfinal WHERE JRFseries='$get_id';";
...
//				select * from tb_equipment where item_category=1;";
         ...
         mysql_query("update asset_depreciation set price='$price',
          salvage_val='$sv',years='$years',depmed='$method' where item_id='$id'") 
                ...
                <script>
				alert('Job Request Successfully Acknowledge...');
				window.location.href='JRFRequest.php';
				</script>
                <?php
			}
			else{
...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
                    ...
                    <div class="main-page">
                         ...
                         <h1 class="btn btn-primary" style="font-size:24px; width:1586px;">Acknowledged Job Request 
								</h1>  
<?php include('jrfinclude.php');?>								
...
?>
    ...
    <div class="col-sm-10">
   	  <textarea class="form-control" type="text" rows="8" name="disapprovereasons" value="<?php echo $disapprovereasons; ?>"/><?php echo $disapprovereasons;?></textarea>
    </div>
  </div>  
    ...
    <div class="col-sm-10">
   	  <input class="form-control" type="text" name="acknowledgeddate" value="<?php echo date("Y/m/d") ?>" readonly />
    </div>
  </div>
...
echo date('l jS \of F Y h:i:s A');?>" style="display:none;">
  ...
  <input type="text" name="Activity" value="<?php echo$_SESSION['sess_fname'];?> <?php echo $_SESSION['sess_lastname'];?> Acknowledged the <?php echo $_SESSION['sess_department'];?> Job Request" style="display:none;">
    ...
    <div class="col-sm-10">
      <input type="text"  name="acknowledgedby"  value="<?php echo $_SESSION[sess_fname];?> <?php echo $_SESSION['sess_lastname'];?>" class="form-control" id="inputPassword3" readonly/>
    </div>
  </div>
    ...
    <label for="inputPassword3" class="col-sm-2 control-label">Update by</label>
    <div class="col-sm-10">
      <input type="text"  name="gostaff"  value="button disabled 9" class="form-control" id="inputPassword3" readonly/>
    </div>
  </div>
