...
tr:hover{
 ...
 <h4 class="btn btn-primary" style="font-size:25px; background-color:#337ab7;;width:auto; border-radius:20px;"> <b class="fa fa-monesy" style="color:white;">&nbsp;&nbsp;Inbox</b></h4>
    ...
    <div class="#">
		 ...
		 <div id="page-wrapper">
            ...
            <table class="display table table-striped" id="example" cellspacing="0" width="100%">
              <thead>
                <tr>
              <th style="width:2%;background-color:#454545; color:white;">Upload_by</th>
               					     <th style="width:11%;background-color:#454545; color:white;">Job&nbsp;Title</th>
				   
						     <th style="width:11%;background-color:#454545; color:white; ">Data&nbsp;Sizes</th>
...
$connection=mysqli_connect('localhost','root','','srms');
 ...
 ;        
        ...
        <td width="140" style="text-align:center; width:15%;">
                <a  rel="tooltip"  title="View" id="v<?php echo $id; ?>"  href="onginternal.php?id=<?php echo $row['Jobtitle'];?>" class="btn btn-primary button button4">View Documents<?php echo $row7[classname];?>&nbsp;<i class="icon-list icon-large"></i></a>
           </td>
      </tr>
      <?php } ?>
                                </tbody>
