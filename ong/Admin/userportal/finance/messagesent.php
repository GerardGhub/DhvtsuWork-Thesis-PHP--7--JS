				...
				<tr><td><form enctype="multipart/form-data"  action="" id="wsb_Form1" name="form" method="post">
										<div class="control-group">
                                          ...
                                          <div class="controls">
											...
											<option></option>
															<?php
														$query = $conn->query("select ongusers.id , ongusers.fname , ongusers.lastname , ongusers.user_image , friends.friends_id   from ongusers  , friends
...
<input type="hidden" value="<?php echo $_SESSION['sess_fname'];?> <?php echo $_SESSION['sess_lastname'];?>" name="sender_name">			
            ...
            <div class="col-md-6 col-sm-9">
				...
				<hr>
				<br>
							<a href="delete_message.php<?php echo '?id='.$id; ?>"  class="btn btn-success" onclick="return confirm('Mark as Read this Selected Message that will move in ReadPage?')"><i class="fa fa-envelope"></i> Read</a>
			<a href="downloadfilemessage.php?filename=<?php echo $name;?>" class="btn btn-primary" onclick="return confirm('Download this Selected File <?php echo $name;?>?')"><i class="icon-file"></i> Download</a>
			<a href="delete_message.php<?php echo $id;?>" class="btn btn-danger" onclick="return confirm('Report the sender for inapporiate Behavior that will send in MIS Team?')"><i class="fa fa-warning"></i> Report</a>
				</div>
				</div>
				<?php } ?>
            </div>
    ...
    popup.classList.toggle("show");
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Message Sent <?php echo $_SESSION['sess_fname'];?> !");
