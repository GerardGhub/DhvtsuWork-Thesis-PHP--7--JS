...
<div class="alert alert-primary" role="alert">
   ...
   include('connect.php');
           ...
           $get_id=$_GET['fname']; 
               ...
               $query = mysql_query("select * from jobrequestfinalpending where Name='$get_id'") or die(mysql_error());
...
>
  ...
  ash icon-large" readonly></i></a-->
    ...
    <!-- /#wrapper -->										 
			...
			$get_id=$_GET['fname'];
            $cats=$row['Prepared_By'];
            $query7 = mysql_query("select * from jobrequestfinalpending where Name='$get_id'") or die(mysql_error());
            $row7 = mysql_fetch_array($query7);
            echo $row7['Name']; 

?>			</td> Job Request Pending</b></h4>
