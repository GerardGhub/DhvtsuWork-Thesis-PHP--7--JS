...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
 ...
 <h4 class="btn btn-primary" style="font-size:17px; background-color:skyblue;"> <b style="color:black;">Finance Department Policies</b></h4>
    ...
    <div class="#">
        ...
        ?>
		   ...
		   include('../connect.php');
               ...
               $query = mysql_query("select distinct category_id from mis") or die(mysql_error());
	  ...
	  <td> <?php echo  $department;?></td>
              ...
              <td><?php
			     include('connect.php');
            $cat=$row['category_id'];
            $query7 = mysql_query("select * from miscategory where category_id='$cat'") or die(mysql_error());
        ...
        <td width="140" style="text-align:center;">
                <a  rel="tooltip"  title="View" id="v<?php echo $id; ?>"  href="memolist.php?id=<?php echo $row['Subject_identity'];?>" class="btn btn-primary">View <?php echo $row7[Subject_name];?>&nbsp;Memorandum<i class="icon-list icon-large"></i></a>
           </td>
      </tr>
      <?php } ?>
                                </tbody>
