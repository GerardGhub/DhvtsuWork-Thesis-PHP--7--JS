...
<div class="alert alert-primary" role="alert">
   ...
   include('connect.php');
           ...
           $get_id=$_GET['fname']; 
               ...
               $query = mysql_query("select * from jobrequestcompleted where Name='$get_id'") or die(mysql_error());
...
>
  ...
  ash icon-large" readonly></i></a-->
    ...
    <!-- /#wrapper -->										 
	        ...
	        <h4 class="btn btn-primary" style="font-size:24px; background-color:#337ab7; width:1603px;"> <b class="fa fa-read" style="color:white;">  
			<td><?php include('connect.php');
			$get_id=$_GET['fname'];
            $cats=$row['Prepared_By'];
            $query7 = mysql_query("select * from jobrequestcompleted where Name='$get_id'") or die(mysql_error());
            $row7 = mysql_fetch_array($query7);
            echo $row7['Name']; 

?>			</td> Job Request Completed</b></h4>
