...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
		...
		<div class="alert alert-info" style="color:white;background-color:#008CBA; width:1617px;">
         <center><h4> <span class="fa fa-users"></span> <b>Admin Policy & Procedures List of Holiday</b></h4></center>
    ...
    <div class="#">
		 ...
		 <div id="page-wrapper">
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
              <thead>
                <tr>
              <th style="width:5%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">#</th>
	    ...
	    <th style="width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">Day</th>
		  <th style="width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">Date</th>
		    <th style="width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">Holiday</th>
			  <th style="width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">Comments</th>
           ...
           <?php
		   include('connect.php');
               $query = mysql_query("select * from holidaymemo") or die(mysql_error());
      ...
      <tr>
	  	   ...
	  	   <!--td class="zoom" style="width:6%;">
              ...
              <td style="width:2%;"><?php echo $row['Memo_id'];?></td>
