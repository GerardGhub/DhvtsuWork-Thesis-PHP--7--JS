...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
                    ...
                    <?php include('../includes/totheleftmessengerhome.php');?>  
  ...
  <div class="row" style="background-color:whitesmoke;">
      ...
      <div class="panel">
        <div class="panel-body">
          ...
          <div class="row">    
            <br>
				<?php
	$query = $conn->query("select * from post LEFT JOIN ongusers on ongusers.id = post.member_id order by date_posted DESC");
	...
	?>
            <div class="col-md-2 col-sm-3 text-center">
             <img  src="../item_images/<?php echo $posted_image; ?>" style="width:100px;height:100px" class="img-circle"></a>
            </div>
            <div class="col-md-10 col-sm-9">
              ...
              <div class="row">
                <div class="col-xs-9">
                  ...
                  <small style="font-family:courier,'new courier';" class="text-muted">Posted By:<a href="#" class="text-muted"><?php echo $posted_by; ?> (<?php echo $department;?>)</a></small>
                  </h4></div>
