...
include('connect.php');
	...
	{
		$id = $_GET['JRFseries'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM Jobrequestcompleted WHERE JRFseries=:JRFseries');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		$item_category = $_POST['item_category'];
			...
			$datemodified =$_POST['date_modified'];
			    ...
			    mysql_query("insert into Jobrequestfinal   (Jrfseries,Date_now,Type,Name,Department,JobReq,Purpose,Preparedby,DH,JRFno,MISOIC,Status,Process) values
     ('$id','$Date_now','$Type','$Name','$Department','$JobReq','$Purpose','$Preparedby','Rollaine C. Palo','$JRFno','Jerwin Ibañez','On Approval','Waiting')") or die(mysql_error());
...
mysql_query("delete from Jobrequest where JRFseries='$get_id'")or die(mysql_error());
?>
...
html, body{
    ...
    <body class="top-navbar-fixed">
            ...
            <!-- ========== TOP NAVBAR ========== -->
   <?php include('../includes/approvejrf.php');?> 
...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
	...
	<center><div class="alert alert-info quadra2t" style="color:white;background-color:#008CBA; width:1610px;">
         <center><h4> <span class="	fa fa-view" style="color:white;"></span> <b style="color:white;">View Selected Job Request Form  </b></h3></center>
...
<table class="table table-bordered table-responsive">
  <tr>
    ...
    <th style="color:black;"><input type="text" id="username" class="btn btn4" size="5" style="color:black; background-color:white; border-color:greys;"name="JRFno" value="<?php echo $JRFseries; ?>" class="input-xlarge" readonly/></th>
  </tr>
