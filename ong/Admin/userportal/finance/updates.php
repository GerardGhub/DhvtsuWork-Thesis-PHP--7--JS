...
$today = date("F Y"); ?></th>
	...
	-->										 
	  ...
	  <footer>
		...
		<div class="alert alert-info" style="color:white;background-color:whitesmoke; width:1635px;">
         <center><h4> <span class="fa fa-users"></span> <b style="color:black;"><?php echo $_SESSION['sess_department'];?> Stock Level for the Month.</b></h4></center>
