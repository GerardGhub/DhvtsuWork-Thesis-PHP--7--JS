...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
                    ...
                    <?php include('../includes/totheleftallfiles.php');?>  
         ...
         <center><h4> <span class="fa fas-userss"></span> <b>All Department Shared Files&nbsp;<span id="val"></span>&nbsp;Megabytes</b></h4></center>
...
<div class="alert alert-primary" role="alert">
    ...
    <div class="#">
		 ...
		 <div id="page-wrapper">
            ...
            <table class="display table table-striped" id="example" cellspacing="0" width="100%">
              <thead>
                <tr>
              <th style="width:1%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">IMAGE</th>
                <th style="width:5%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">FILE&nbsp;ID</th>
		                <th style="width:8%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">FILE&nbsp;NAME</th>
						        <th style="width:4%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">FILE&nbsp;SIZE</th>
						   <th style="width:5%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">UPLOAD&nbsp;BY</th>
			 <th style="width:5%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">DEPARTMENT</th>
		                <th style="width:5%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">DATE&nbsp;ADDED</th>
								  <th style="width:12%;background-color:#454545; color:white; text-align:center; font-size:15px; color:white;">ACTIONS</th>
   ...
   include('connect.php');
           ...
           $get_id=$_GET['id']; 
               $query = mysql_query("select * from filemgrhr  ORDER by item_id DESC
			   ") or die(mysql_error());
