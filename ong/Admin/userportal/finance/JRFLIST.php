...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
                    ...
                    <?php include('../includes/JRFPageLEFTcreated.php');?>  
       ...
       <h4 class="btn btn-success" style="font-size:17px;"> <b>&nbsp;Memorandum Subject's</b>
		...
		<center><b style="text-align:center;  font-size:20px;">Job Request Lists <?php echo $_SESSION['sess_department'];?></b></center>
         <!--center><h3> <span class="fa fa-laptop"></span> <b>Job Request Lists</b></h3></center-->
        </div>
    ...
    <div class="#">
		 ...
		 <div id="page-wrapper">
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
              <thead>
                <tr>
              <th style="width:5%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">JRFno</th>
						    ...
						    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Department</th>
							    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Job Request</th>
								    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Purpose</th>
									    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Requisitioner</th>
        ...
        ?>
		   ...
		   include('../connect.php');
		   			 $department =$_SESSION['department'];
               $query = mysql_query("Select * from Jobrequest where department='$department'") or die(mysql_error());
      ...
      <tr>
        ...
        <!--td width="140" style="text-align:center;">
		 ...
		 <a rel="tooltip" class="btn btn-info" href="editjrf.php?JRFno=<?php echo $row['JRFno']; ?>" title="Click for Edit" onclick="return confirm('Edit This Selected Job Request Form?')"><span class="glyphicon glyphicon-edit" style="font-size:17px; color:white;"></span></a> 
...
<!-- href="view_equipment.php?id=<?php echo $item_id;?>" -->
		 ...
		 <a rel="tooltip" class="btn btn-primary" href="SubmitJRF.php?JRFno=<?php echo $row['JRFno']; ?>" title="Job Request Proceed?" onclick="return confirm('Submit This Selected Job Request Form into MIS?')"><span class="glyphicon glyphicon-open" style="font-size:17px; color:white;"></span></a> 
  ...
  <!--a  rel="tooltip"  class="btn btn-primary" title="Job Request Proceed?" id="v<?php echo $id; ?>"  href="fixedasset_reportsticker.php?id<?php echo $item_category;?>" class="btn btn-light"><span class="glyphicon glyphicon-check" style="font-size:17px; color:white"></span></i></a-->
         ...
         <a rel="tooltip" class="btn btn-danger" title="Delete" id="<?php echo $id; ?>" href="#delete_equipment.php?id=<?php echo $item_id;?>" data-toggle="modal"    class="btn btn-light"><span class="glyphicon glyphicon-trash" style="font-size:17px; color:white"></span><i class="icon-tr
