...
<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		header("Location: manageuserfinance.php");
	}
...
<?php include('../includes/financeleftbar.php');?>  
                    ...
                    <div class="main-page">
                            ...
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="fa fa-users" style="font-size:23px;">Manage Finance Users</h4>
    ...
    <div class="#">
		 ...
		 <div id="page-wrapper">
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("config.php");
	$stmt = $DB_con->prepare('SELECT * FROM ongusers where department="Finance Department"; ');
	$stmt->execute();
