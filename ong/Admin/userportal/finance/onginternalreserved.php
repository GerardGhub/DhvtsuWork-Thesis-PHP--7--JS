...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
   ...
   <!--h4 class="btn btn-primary" style="font-size:19px;">Fixed Asset File Manager
     ...
     <h4 class="btn btn-primary" style="font-size:25px; background-color:#337ab7; width:1617px;"> <b class="fa fa-read" style="color:white;">&nbsp;<b>INBOX RESERVED</b> &nbsp;
...
<div class="alert alert-primary" role="alert">
   ...
   include('connect.php');
         ...
         $get_id=$_GET['id']; 
               $query = mysql_query("select * from postingsenderreserved where Jobtitle ='$get_id' ORDER by item_id DESC
			   ") or die(mysql_error());
...
-->
			...
			<a href="downloadresume.php?filename=<?php echo $name;?>"  class="btn btn-success" title="Click to Download"  onclick="return confirm('Are you sure to Download this Selected File?')"></span>Passed</a>
</td>
<td>
					 
 	<a href="downloadresume.php?filename=<?php echo $name;?>"  class="btn btn-danger" title="Click to Download"  onclick="return confirm('Are you sure to Download this Selected File?')"></span>Not&nbsp;Qualified</a>			
...
//SELECT //item_id,Jobtitle,Type,Jobdescription,item_image,item_date,Education,dh,category_id,Vacancy,status,img_name,img_path,img_type,WorkXP,Gender,S//alary,skills,fname,mname,lname,Contact,Email,upload_by,department FROM postingsender WHERE Jobtitle='$get_id'";
							//	 $sql=" DELETE FROM postingsender
								// WHERE item_id='$item_id'";
								  ...
								  echo '<script>window.location.href="onginternal.php"</script>';
