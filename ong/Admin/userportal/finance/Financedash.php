...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
 ...
 <h4 class="btn btn-primary" style="font-size:25px; background-color:#337ab7;;width:1618px;"> <b class="fa fa-money" style="color:white;">&nbsp;&nbsp;Finance Department Policies</b></h4>
    ...
    <div class="#">
        ...
        ?>
		   ...
		   include('../connect.php');
               ...
               $query = mysql_query("select distinct category_id from financedepfinal where blink='1'") or die(mysql_error());
	  ...
	  <td> <?php echo  $department;?></td>
              ...
              <td><?php
			     include('connect.php');
            $cat=$row['category_id'];
            $query7 = mysql_query("select * from financedepfinal where category_id='$cat'") or die(mysql_error());
          ...
          $category_idoppa=$row['category_id'];
                    $count_query = mysql_query("select * from financecategory where dep_sec='$category_idoppa'") or die(mysql_error());        
