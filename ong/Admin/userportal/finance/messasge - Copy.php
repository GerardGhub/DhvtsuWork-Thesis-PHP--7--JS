  ...
  <div class="row">
            ...
            <div class="col-md-6 col-sm-3 text-center">
						...
						<form method="post" id="send_message" action="send_message.php">
										<div class="control-group">
											<label>To:</label>
                                          <div class="controls">
                                            <select name="friend_id" class="combo" width="100" required>
											<option></option>
															<?php
	...
	");
										...
										<div class="control-group">
											<label>Content:</label>
                                          <div class="controls">
											<textarea name="my_message" class="my_message" style="border-radius:40px;" required></textarea>
                                          </div>
                                        </div>
										<hr>
										<div class="control-group">
                                          <div class="controls">
												<button  class="btn btn-success"><i class="icon-envelope-alt" style="font-size:17px;"></i> Send </button>
