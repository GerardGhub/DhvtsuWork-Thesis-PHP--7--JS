...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
	   ...
	   <ul>
  <li style="float: left; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;border:white;"><a class="JRFREQUEST.php" href="JRFREQUEST.PHP" style="color:white;font-size:17px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home Current Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
  ...
  <li style="float: left;"  class="active"><a href="#JRFREQUEST3.php" style="color:white;font-size:17px; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job Request Pending&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
  
  
  
  <li style="float: left; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;"><a href="JRFREQUEST4.php" style="color:white;font-size:17px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job Request Disapproved&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
</ul>
						    ...
						    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Job&nbsp;Request</th>
								    ...
								    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Purpose</th>
									    ...
									    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">MIS&nbsp;OIC</th>
															    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Pending&nbsp;Reasons</th>
					
					
					
			 

 <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Pending&nbsp;by</th>	
<th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Date&nbsp;of&nbsp;Pending</th>	 
        ...
        ?>
		   ...
		   $department = $_SESSION['sess_department'];
               $query = mysql_query("Select * from Jobrequestfinalpending where department='$department'") or die(mysql_error());
...
<!-- href="view_equipment.php?id=<?php echo $item_id;?>" -->
  ...
  <!--a  rel="tooltip"  class="btn btn-primary" title="Job Request Proceed?" id="v<?php echo $id; ?>"  href="fixedasset_reportsticker.php?id<?php echo $item_category;?>" class="btn btn-light"><span class="glyphicon glyphicon-check" style="font-size:17px; color:white"></span></i></a-->
         ...
         <!--a rel="tooltip" class="btn btn-primary" title="fillout an Pending Reason regarding in your Job Request?" id="<?php echo $id; ?>" onclick="return confirm('Are you sure you want to delete?')" href="#delete_equipment.php?id=<?php echo $item_id;?>" data-toggle="modal"    class="btn btn-light"><span class="glyphicon glyphicon-trash" style="font-size:17px; color:white"></span><i class="icon-tr
  ash icon-large" readonly></i></a-->
  
  
  
         <a rel="tooltip" class="btn btn-primary" title="fillout an Pending Reason regarding in your Job Request?" id="<?php echo $id; ?>" onclick="return confirm('Reason for Pending Job Request?')" href="editreasonforpending.php?JRFseries=<?php echo $row['JRFseries']; ?>" data-toggle="modal"    class="btn btn-light"><span class="glyphicon glyphicon-edit" style="font-size:17px; color:white"></span><i class="icon-tr
  ash icon-large" readonly></i></a>
