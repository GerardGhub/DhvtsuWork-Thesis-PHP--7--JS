...
$sql1 ="SELECT * from jobrequestfinal where department='$department' ";
...
?>
                                            ...
                                            <span class="number counter"><?php echo htmlentities($totalstudents);?></span>
                                                    <span class="name">Job Request Released Status&nbsp;</span><!--?php echo ($totalsubject);?-->&nbsp;
...
<?php 
$department =$_SESSION['sess_department'];
$sql1 ="SELECT * from jobrequestfinalstatus where department='$department' ";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalstudents=$query1->rowCount();
...
?>
                                            ...
                                            <span class="name" style="color:white;">Job Request Disapprove&nbsp;<!--?php echo ($totalsubject);?>&nbsp;Category-->
...
<?php
$department=$_SESSION['sess_department']; 
$sql ="SELECT * from jobrequestcompleted where department='$department' ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
                                            ...
                                            <span class="name" style="color:black;">Job Request Completed</b>&nbsp;&nbsp;</span><emp style="color:black;"><!--?php echo ($totalsubject);?>&nbsp;Category--></b></emp>
...
<?php 
$department=$_SESSION['sess_department'];
$sql ="SELECT * from messagereported where department='$department' ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totalsubjects=$query->rowCount();
...
?>
                                            ...
                                            <span class="number counter" style="color:white;"><?php echo ($totalsubjectsa);?> </span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        ...
                                        <?php 
								//		$my_idpersonal=$_SESSION['sess_user_id'];
//$sql2 ="SELECT * from friends where my_id='1' ";

$department=$_SESSION['sess_department'];
$sql ="SELECT * from jobrequestpending where department='$department' ";
...
?>
                                            ...
                                            <span class="name">Job Request Pending </span><!--?php echo ($totalsubject);?>&nbsp;Category-->
                                        ...
                                        <?php 
										$department=$_SESSION['sess_department'];
$sql2 ="SELECT * from messagesents where department='$department' ";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totalclasses=$query2->rowCount();
...
$totalsubject=$query->rowCount();
?>
                                            <span class="number counter" ><?php echo htmlentities($totalclassesa);?></span>
                                            <span class="name">&nbsp; </span><!--?php echo ($totalsubject);?>&nbsp;Category-->
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									 ...
									 <a class="dashboard-stat" style="background-color:gray;" href="#">
                                        <?php 
$sql3="SELECT * from aa2000.tb_equipment where item_category=7;";
...
?>
                                            ...
                                            <span class="name" style="color:white;">Job Request Disapprove & Reasons</span>&nbsp;<emp style="color:white;"><!--?php echo ($totalsubject);?>&nbsp;Category--></emp>
                                        ...
                                        <?php 
$sql3="SELECT  * from operationdivisiondepartment ";
$query3 = $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$totalresults=$query3->rowCount();
...
?>
                                            ...
                                            <span class="number counter" style="color:white;"><?php echo htmlentities($totalresultsa);?></span>
    ...
    popup.classList.toggle("show");
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Welcome <?php echo $_SESSION['sess_fname'];?> to O&G Admin Policy * Procedures!");
