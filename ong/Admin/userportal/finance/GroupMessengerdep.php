...
if (!$con)
  ...
  die('Could not connect: ' . mysql_error());
	...
	{
	         header('Location:Groupmessengerdep2.php');	
	}
mysql_select_db("chatting", $con);
		...
		mysql_query("INSERT INTO messagefinance(message, sender, image_user,department)VALUES('$message', '$sender', '$image_user','$department')");
}
...
.hero-image {
  background-image: url("../item_images/blackpink.jpg");
...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
                    ...
                    <?php include('../includes/leftdep.php');?>  
 ...
 <h4 class="btn btn-primary" style="font-size:22px; background-color:#4267; width:1599px;"> <img src="..\item_images\icon.png"height="47"width="75" style="bakground-color:white;"></img><emp style="color:whitesmoke;  background-colorfont-family:"Lucida Console", Monaco, monospace;"><b><?php echo $_SESSION['sess_department'];?> Groupchat Messenger</b></emp><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<emp style="color:whitesmoke; text-align:center;">Active now&nbsp;<i class="	fa fa-circle-thin" style="background-color:orange;color:orange;border-radius: 70%;"></i></emp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<emp style="color:yellow; font-size:12px;"><?php 
 $department=$_SESSION['sess_department'];
 
 $sql ="SELECT * from ongusers where department='$department'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totalsubjectsxx=$query->rowCount();
 
 
 
 
 echo htmlentities($totalsubjectsxx);?> members on this group</emp></h4>
...
mysql_select_db("chatting", $con);
$department =$_SESSION['sess_department'];
$result = mysql_query("SELECT * FROM messagefinance where department='$department' ORDER BY id DESC");
