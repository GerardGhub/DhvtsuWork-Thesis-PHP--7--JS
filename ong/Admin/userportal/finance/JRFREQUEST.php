...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
	   ...
	   <ul>
  <li style="float: left;"><a class="active" href="#home" style="color:white;font-size:17px; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home Current Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
  <li  style="float: left; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;"><a href="JRFREQUEST2.php" style="color:white;font-size:17px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job Request Done Completed&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
  <li  style="float: left;left; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;"><a href="JRFREQUEST3.php" style="color:white;font-size:17px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job Request Pending&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
  <li  style="float: left;left; display: block;  color: white;  text-align: center;  padding: 14px 16px;  text-decoration: none;"><a href="JRFREQUEST4.php" style="color:white;font-size:17px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job Request Disapproved&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
</ul>
    ...
    <div class="#">
		 ...
		 <div id="page-wrapper">
						  ...
						  <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Type</th>
						    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Job&nbsp;Request</th>
								    ...
								    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Purpose</th>
											    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Manager</th>
									    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">MIS&nbsp;OIC</th>
															    <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Status</th>
					
					
					
			 <th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Process</th>		
			...
			<!--th style="width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">No of Memorandum</th-->
				...
				<!--h style="width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;">Posted</th>
					...
					<th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Acknowledged</th>
					
				  	<th style="width:11%;background-color:whitesmoke; color:black; text-align:center; font-family:Times New Roman, Times, serif;">Pending</th>
        ...
        ?>
		   ...
		   $department =$_SESSION['sess_department'];
               $query = mysql_query("Select * from Jobrequestfinal where department='$department' ORDER BY date_now DESC") or die(mysql_error());
      ...
      <tr>
		...
		<?php echo $row['JRFseries'];?>
		     ...
		     <a rel="tooltip" class="btn btn-ins" title="Acknowledged The Job Request?" id="<?php echo $id; ?>"  href="viewjrf.php?JRFseries=<?php echo $row['JRFseries']; ?>" data-toggle="modal"    class="btn btn-light"><span class="glyphicon glyphicon-eye-open" style="font-size:10px; color:black"></span><i class="icon-tr
  ash icon-large" readonly></i></a>
				 </td>
	  
	 
	     <td class="zoom" style="text-align:center;font-size:13px;">
		...
		<?php echo $row['Type'];?>&nbsp;<?php echo $row['Typeothers'];?>
				 		      ...
				 		      <td class="zoom" style="text-align:center;font-size:13px;width:18%;">
		<?php echo $row['JobReq'];?>
				 </td>
				 		      <td class="zoom" style="text-align:center; font-size:13px;width:18%; font-size:13px;">
		<?php echo $row['Purpose'];?>
				 </td>
				 			 		      <td class="zoom" style="text-align:center;font-size:13px;width:10%;">
		<?php echo $row['DH'];?>
				 </td>
	<td class="zoom <?php echo $row['MISOIC'];?>" style="text-align:center;font-size:13px;">
		<!--?php echo $row['MISOIC'];?-->Jerwin Ibañez
				 </td>
				 
	  
	  		 			 		      <td class="zoom <?php echo $row['Status'];?>" style="text-align:center;font-size:13px;">
		<?php echo $row['Status'];?>
				 </td>
...
<!-- href="view_equipment.php?id=<?php echo $item_id;?>" -->
  ...
  <!--a  rel="tooltip"  class="btn btn-primary" title="Job Request Proceed?" id="v<?php echo $id; ?>"  href="fixedasset_reportsticker.php?id<?php echo $item_category;?>" class="btn btn-light"><span class="glyphicon glyphicon-check" style="font-size:17px; color:white"></span></i></a-->
         ...
         <a rel="tooltip" class="btn btn-primary <?php echo $row['gostaff'];?>" title="Acknowledged The Job Request?" id="<?php echo $id; ?>" onclick="return confirm('Are you sure you want to Acknowledged this Job Request?')"  href="acknowledgeby.php?JRFseries=<?php echo $row['JRFseries']; ?>" data-toggle="modal"    class="btn btn-light"><span class="glyphicon glyphicon-thumbs-up" style="font-size:17px; color:white"></span><i class="icon-tr
  ash icon-large" readonly></i></a>
		 ...
		 <td>
		 	     <a rel="tooltip" class="btn btn-danger <?php echo $row['disabled'];?>" title="Mark as a Pending?" id="<?php echo $id; ?>" onclick="return confirm('Are you sure you want Mark as a Pending The Selected JRF ?')" href="pendinglol.php?JRFseries=<?php echo $row['JRFseries']; ?>" data-toggle="modal"    class="btn btn-light"><span class="glyphicon glyphicon-floppy-remove" style="font-size:17px; color:whitesmoke;"></span><i class="icon-tr
  ash icon-large" readonly></i></a>
