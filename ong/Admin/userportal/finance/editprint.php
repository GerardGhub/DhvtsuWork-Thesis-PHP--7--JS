...
<!-- Comment muna this left assets -->
                    ...
                    <div class="main-page">
                            ...
                            <div class="row page-title-div">
						        ...
						        <!--  REMOVE The Previous Blue    a class="btn btn-dangers" title="Back into Previous Page"  onclick="goBack()"> <span class="glyphicon glyphicon-backward"></span> </a-->    
								...
								<!--h4 class="fa fa-file-text" style="font-size:22px;">Update Assets Information
								</h4-->
 ...
 <!--h4 class="btn btn-primary" stye="font-size:17px;">Update Assets Information
								</h4-->   	                               

								
	<!-- REQUEST  IT PRINT  -->							   
<!--center style="text-align:left;"><a href="" id="printpagebutton" class="btn btn-danger" class="glyphicon glyphicon-print" onclick="myFunction()">Print</a></cente-->
				 	...
				 	<!--h4 class="btn btn-primary" stye="font-size:17px;">Update <?php echo $item_name;?> Information
								</h4></img--> 
...
?>
	 ...
	 <?php
		 ...
		 <!--?php
            $fat=$row['sub_category'];
            $query9 = mysql_query("select * from subcategory where subcat_id='$fat'") or die(mysql_error());
		 ...
		 <!--?php
            $gat=$row['item_category'];
            $query10 = mysql_query("select * from item_category where category_id='$gat'") or die(mysql_error());
            $row10 = mysql_fetch_array($query10);
   
            ?>
	
	<!--?php
            $gigabyte=$row['supplier_id'];
            $query11 = mysql_query("select * from supplier where sup_id='$gigabyte'") or die(mysql_error());
	...
	<!--center-->
			 ...
			 <div class="alert alert-white" style="border:none;">
                     <div class="top-left">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../item_images/GerardSS.jpg" height="85"width="160"></img></div><center style="font-size:35px; font-family:Times New Roman, Times, serif;">MEMORANDUM</center>  <div class="top-right" style="font-size:15px;"><b><?php echo $Series_Code;?></b><!--MIS-0101-2018--></div><emp style="vertical-align: text-bottom:50%;"> <!--dhshdsds--></emp>
 ...
 <table border="0">
    ...
    <div class="col-sm-10">
   	  <input class="form-control" type="text" name="Two" value="<?php echo $Two; ?>" style="border:none; font-size:18px;" required />
    </div>
    ...
    <div class="col-sm-10">
   	  <input class="form-control" type="text" name="item_name" value="<?php echo $Fromo; ?>"style="border:none; font-size:18px;" readonly />
    </div>
    ...
    <div class="col-sm-10">
   	  <input class="form-control" type="text" name="item_name" value="<?php echo $Date; ?>" style="border:none; font-size:18px;" readonly />
    </div>
    ...
    <div class="col-sm-10">
   	  <input class="form-control" type="text" name="item_name" value="<?php echo $Subject_identity;?> -<?php echo $Subject_Date; ?>" style="border:none; font-size:18px;" required />
    </div>
...
<?php
	...
	&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<emp style="font-size:15px;">Please be informed that <b><?php echo $row['Name'];?></emp>
		...
		</b> <emp style="font-size:15px;">is required to work on <b><?php echo $Subject_Date;?></emp></b> &nbsp;&nbsp;<b><emp style="font-size:15px;"><?php echo $row12['Subject_name'];?></emp></b><emp style="font-size:15px;"> from 9am to 5pm to support the Operation Division.</emp>
		<br>
		<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<emp style="font-size:15px;">Overtime will be paid accordingly.</emp>
...
?-->
    ...
    <!--select  class="form-control" id="inputPassword3" name="method" required/-->
	 ...
	 <b><emp style="font-size:21px;"><input type="text" style="border:none;" value="<?php echo $row['Name'];?>"></emp></b>
    


 <emp style="font-size:15px;"><input type="text" style="border:none;" value="<?php echo $row['position'];?>" readonly></emp>
    ...
    <!--select  class="form-control" id="inputPassword3" name="method" required/-->
	   ...
	   include('connect.php');
        ...
        ?>
         <!--input type="text" value="<?php echo $row['Name'];?>"></option-->
    <b><emp style="font-size:15px;"><input type="text" style="border:none;" value="<?php echo $row['Name'];?>"></b></emp>
     <!--?php echo $row['position'];?--><p>
	    <emp style="font-size:21px;"><input type="text" style="border:none;" value="<?php echo $row['position'];?>" readonly></emp>
          <!--?php
		  include('conface.php');
        $query=mysql_query("select * from dep_method") or die (mysql_error());
        while($row=mysql_fetch_array($query)){
...
?>
    ...
    <tr>
        <td colspan="8" style="display:nonesense;">
