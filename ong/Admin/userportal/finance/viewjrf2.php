...
<!--?php include('../includes/misleftbaruseruser.php');?-->  
                    ...
                    <div class="main-page">
                     ...
                     <h1 class="btn btn-primary" style="font-size:24px; width:1586px;"></img>Job Request Form<br>(MIS)
								</h1>  &nbsp;
<?php include('jrfincludeview2.php');?>								
...
?>
    ...
    <div class="col-sm-10">
      <input type="text"  name="life"  value="<?php echo $Preparedby;?>" class="form-control" id="inputPassword3" readonly/>
        ...
        <td colspan="8" style="border:none; display:none;">
