...
.hero-image {
  background-image: url("../userportal/item_images/transformer.jpg");
...
?>
                                            ...
                                            <span class="number counter"><?php echo htmlentities($totalstudents);?></span>
                                                    <span class="name">MIS Department&nbsp;Sections</span><!--?php echo ($totalsubject);?-->&nbsp;
...
<?php 
$department =$_SESSION['sess_department'];
$sql1 ="SELECT * from ongusers where status='active' ORDER BY department='MIS'";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalstudents=$query1->rowCount();
...
?>
                                            ...
                                            <span class="name" style="color:white;">MIS Registered Actived Users&nbsp;<!--?php echo ($totalsubject);?>&nbsp;Category-->
...
?>
                                            ...
                                            <span class="name" style="color:black;">MIS Subject Category</b>&nbsp;&nbsp;</span><emp style="color:black;"><!--?php echo ($totalsubject);?>&nbsp;Category--></b></emp>
...
<?php 
$department=$_SESSION['sess_department'];
//$sql ="SELECT * from messagereported wh ";
$sql ="SELECT * from mis";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
                                            ...
                                            <span class="name"><!--Personal Message Reported-->&nbsp;&nbsp;</span>MIS Department Total Policy Pages <!--?php echo ($totalsubject);?>&nbsp;Category-->
...
$department=$_SESSION['sess_department'];
$sql2 ="SELECT * from jobrequestfinalpending";
...
?>
                                            ...
                                            <span class="name">Total number of Memorandum </span><!--?php echo ($totalsubject);?>&nbsp;Category-->
...
//$sql2 ="SELECT * from jobrequestfinalpending ";
$sql2 ="SELECT * from ongusers where status='inactive' ORDER BY department='MIS'";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totalclasses=$query2->rowCount();
...
?>
                                            ...
                                            <span class="name">&nbsp; MIS Registered inactive Users</span><!--?php echo ($totalsubject);?>&nbsp;Category-->
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									 ...
									 <a class="dashboard-stat" style="background-color:gray;" href="#">
                                        <?php 
$sql3="SELECT * from tblcheck where department='MIS'";
...
?>
                                            ...
                                            <span class="name" style="color:white;">Department User Logs</span>&nbsp;<emp style="color:white;"><!--?php echo ($totalsubject);?>&nbsp;Category--></emp>
										...
										<br>
										   ...
										   <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
												 <a class="dashboard-stat"style="background-color:green;" href="misdashboardfinaljob.php">
                                        <?php 
$sql3="SELECT  * from miscategory";
$query3 = $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$totalresults=$query3->rowCount();
...
?>
                                            ...
                                            <span class="number counter" style="color:white;"><?php echo htmlentities($totalresults);?></span>
                                            <span class="name" style="color:white;">Browse MIS Department Policy<!--Department Groupchat		-->&nbsp;									</span><emp style="color:white;"<?php echo ($totalsubject);?>&nbsp;Category
