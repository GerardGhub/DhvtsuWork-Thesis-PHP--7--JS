...
$query=$conn->query("INSERT INTO mis (item_image,item_date) VALUES ('$name','$date')");
if($query){
header("location:indexsundaywork.php");
}
else{
die(mysql_error());
}
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<th>Remove</th>
                            ...
                            <tbody>
							<?php 
							$query=mysql_query("select * from mis ORDER BY item_id DESC")or die(mysql_error());
				...
				<td>
				<a href="myfilemmgr/delete.php?del=<?php echo $row['id']?>"><span class="glyphicon glyphicon-trash" style="font-size:20px; color:red"></span></a>
				</td>
                                </tr>
