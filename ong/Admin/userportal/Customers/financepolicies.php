                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <!--h3 class="title" style="font-weight:bold; color:gray;">Finance Department Policy</h3-->  <h4 class="btn btn-primary" style="font-size:17px; background-color:lightgray;"> <b style="color:black;">Finance Department Policy and Procedure </b></h4>								   
...
{		
	...
	$("#getfinancepolicies").change(function()
	{				
