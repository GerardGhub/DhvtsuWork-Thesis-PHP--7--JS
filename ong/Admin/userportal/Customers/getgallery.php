...
<head>
    ...
    <title>Admin Policy and Procedure</title>
...
$query=mysql_query("SELECT item_id, policy_title, item_image, revisionno, img_name, department FROM gallery ORDER BY department LIMIT $start, $limit");
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['policy_title']."</textarea>
           ...
           <a class='fancybox-buttons' href='/adminportal local/item_images/".$query2['img_name']."' data-fancybox-group='button' title='Page ".$ip."- ".$query2['policy_title']."'>
					...
					<img src='/adminportal local/item_images/".$query2['img_name']."' class='img img-thumbnail'  style='width:350px;height:150px;' />
					</a>
		...
		$stmt=$dbcon->prepare('SELECT item_id, item_image, policy_title, revisionno, img_name, department FROM gallery WHERE category_id=:cid ORDER BY department');
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$policy_title."</textarea>
            ...
            <div class='panel-body'>
            <a class='fancybox-buttons' href='/adminportal local/item_images/$img_name' data-fancybox-group='button' title='Page ".$id."- ".$policy_title."'>
	
					<img src='/adminportal local/item_images/".$img_name."' class='img img-thumbnail'  style='width:350px;height:150px;' />
					</a>
