    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<br>
                    <li class="navbar-inverse"><a href="shop.php"> &nbsp; <span class='glyphicon glyphicon-home'></span> &nbsp;Home</a></li>
					                  <li class="active"><a href="#features-sec"  data-toggle="modal" data-target="#setAccount"> &nbsp; <span class='glyphicon glyphicon-user'></span>	&nbsp;	<?php   extract($_SESSION); echo $user_email; ?></a></li>
					<!--li class="active"><a href="misdata.php?id=1"> &nbsp; <span class='	glyphicon glyphicon-cloud'></span> &nbsp;MIS
					
						<li class="active"><a href="#"> &nbsp; <span class='	glyphicon glyphicon-king'></span>&nbsp;HR
						
							<li class="active"><a href="#"> &nbsp; <span class='glyphicon glyphicon-piggy-bank'></span> &nbsp;Finance
							
								<li class="active"><a href="#"> &nbsp; <span class='	glyphicon glyphicon-star'></span> &nbsp;Logistic
									<li class="active"><a href="#"> &nbsp; <span class='	glyphicon glyphicon-tasks'></span> &nbsp;Manufacturing
										<li class="active"><a href="#"> &nbsp; <span class='	glyphicon glyphicon-usd'></span>&nbsp; Accounting
												<li class="active"><a href="#"> &nbsp; <span class='glyphicon glyphicon-shopping-cart'></span> &nbsp;Purchasing
														<li class="active"><a href""#"> &nbsp; <span class='	glyphicon glyphicon-move'></span>&nbsp;&nbsp;GSD -->
      ...
      <center><h4> <span class=""></span> <b>Home Page</b></h4></center>
        </div>
