  <nav class="navbar top-navbar bg-white box-shadow">
	...
	<li> <a class="btn btn-dangers" title="Back into Previous Page"  onclick="goBack()"> <span class="glyphicon glyphicon-backward"></span> </a></li>							
       ...
       <li><a href="logout.php" title="Sign out" class="color-primary text-center" onclick="return confirm('Are you sure you want to Logout <?php echo $_SESSION['sess_username'];?>?')"><i class="fa fa-sign-out"></i> Logout</a></li>
