                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <p style="font-size:15px;"><a href="../administrative/adminmanageappolicy.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a></p>
                                    ...
                                    <li class="has-children">
																		 ...
																		 <li class="has-children">
                                    <p style="font-size:15px;">    <a href="../administrative/adminmanageappolicy.php"><i class="glyphicon glyphicon-plus"></i> <span>&nbsp;&nbsp;&nbsp;Adding New Data</span> <i class="fa fa-angle-right arrow"></i></a></p>
                                        <ul class="child-nav">
   ...
   <li class="has-children">
     ...
     <li>
									  ...
									  <!--li><a href="dito/librarian/add_books.php"><i class="fa fa fa-server"></i> <span> Add MIS</span></a></li-->
                                       ...
                                       <p style="font-size:15px;"> <a href="../administrative/adminmanageappolicy.php"><i class="fa fa-file-text"></i> <span>Manage O&G Policy </span> <i class="fa fa-angle-right arrow"></i></a></p>
									 ...
									 <li class="has-children">
                                        <p style="font-size:15px;"><a href="../administrative/adminmanageappolicy.php"><i class="fa fa-users"></i> <span>O&G Users</span> <i class="fa fa-angle-right arrow"></i></a></p>
                                        <ul class="child-nav">
                                            <!--li><a href="add-students.php"><i class="fa fa-bars"></i> <span>Add Users</span></a></li-->
										 ...
										 <li class="has-children">
                                        <a href="../administrative/adminmanageappolicy.php"><i class="fa fa-users"></i> <span>M E M O R A N D U M</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <!--li><a href="add-students.php"><i class="fa fa-bars"></i> <span>Add Users</span></a></li-->
									...
									<li class="has-children">
                                       ...
                                       <!--p style="font-size:15px;"> <li><a href="#"><i class="fa fa fa-server"></i> <span> Admin Change Password</span></a></li></p>
