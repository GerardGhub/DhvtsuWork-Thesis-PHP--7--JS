...
<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                      <p style="font-size:15px;">  <a href="../logistic/managelogistic.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a></p>
                                    ...
                                    <li class="has-children">
																		 ...
																		 <li class="has-children">
                                      <p style="font-size:15px;">  <a href="../logistic/managelogistic.php"><i class="glyphicon glyphicon-plus"></i> <span>&nbsp;&nbsp;&nbsp;Adding New Data</span> <i class="fa fa-angle-right arrow"></i></a></p>
                                        <ul class="child-nav">
 ...
 <a href="adminpolicymanage.php"><i class="fa fa-newspaper-o"></i> <span>Manage O&G Policy Count</ </span></a></li>
   ...
   <li class="has-children">
    ...
    <p style="font-size:15px;"><a href="../logistic/managelogistic.php"><i class="fa fa-file-text"></i> <span>Manage O&G Policy </span> <i class="fa fa-angle-right arrow"></i></a></p>
									 ...
									 <li class="has-children">
                                     <p style="font-size:15px;">   <a href="../logistic/managelogistic.php"><i class="fa fa-users"></i> <span>O&G Users</span> <i class="fa fa-angle-right arrow"></i></a></p>
                                        <ul class="child-nav">
                                            <!--li><a href="add-students.php"><i class="fa fa-bars"></i> <span>Add Users</span></a></li-->
										 ...
										 <li class="has-children">
                                        <a href="../logistic/managelogistic.php"><i class="fa fa-users"></i> <span>M E M O R A N D U M</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <!--li><a href="add-students.php"><i class="fa fa-bars"></i> <span>Add Users</span></a></li-->
