...
<?php include('includes/leftbar.php');?>  
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <!--3 class="glyphicon glyphicon-picture" style="font-weight:bold; color:gray;">Photos</h3-->								   
        ...
        <option value="showAll" selected="selected">Show All O&G Event Photos</option>
        <?php
        require_once 'confeg.php';
        
        $stmt = $dbcon->prepare('SELECT * FROM gallerycategory');
        $stmt->execute();
