                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <b> <h3 class="title" style="color:gray;">Logistic Department Policy</b>								   
    	
        <h4>
        <select id="getlogistic">
        <option value="showAll" selected="selected">Show All Category</option>
        <?php
        require_once 'confeg.php';
        
        $stmt = $dbcon->prepare('SELECT * FROM logisticcategory');
        $stmt->execute();
