	  ...
	  <form method="post">
				...
				<!--table cellpadding="8" cellspacing="1" border="1" width="50%" style="border:1px solid blue; font-size:18px; color:blue;"-->
						...
						<th  style="color:blue; font-weight:bold;" width="5%"><center>&nbsp;<input type="checkbox" id = "chckHead" align="center"/></center></th>
										<th style="color:gray; font-weight:bold;" width="7%"><center>POLICY SUBJECT</center></th>
								<th style="font-weight:bold; color:gray;" width="10%"><center>FILE NAME</center></th>
								<th style="font-weight:color; color:gray;" width="11%"><center> REVISION NO</center></th> 
									<th style="font-weight:bold; color:gray;" width="12%"> <center>CATEGORY ID</center></th> 
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				 ...
				 <a class="btn btn-danger" href="download-resultap.php" title="Click for Edit" onclick="return confirm('Are you sure you want to Download All in PDF?')">All in PDF <span class='glyphicon glyphicon-download'></span></a> 
