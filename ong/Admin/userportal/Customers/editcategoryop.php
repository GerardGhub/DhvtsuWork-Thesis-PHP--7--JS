...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM opcategory WHERE category_id=:category_id');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE opcategory
			...
			if($stmt->execute()){
				...
				window.location.href='managecatop.php';
				</script>
                <?php
			}
			else{
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="title"><b>Office of the President Policy</b></h4>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="adminmanageoppolicy.php"><i class="fa fa-home"></i> Home</a></li>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <a class="btn btn-danger" href="managecatop.php"> <span class="glyphicon glyphicon-backward"></span> Cancel </a>
