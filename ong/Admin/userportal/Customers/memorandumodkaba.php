...
<?php include('includes/odmemoleftbarxad.php');?>  

                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <b> <h3 class="title">Operation Division Policy</b>								   
        ...
        $stmt = $dbcon->prepare('SELECT * FROM operationdivision');
        $stmt->execute();
