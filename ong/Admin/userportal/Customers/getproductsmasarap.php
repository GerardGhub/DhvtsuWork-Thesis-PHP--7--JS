...
<head>
    ...
    <title>Admin Policy Portal<b></title>
...
$query=mysql_query("SELECT * from mis");
...
<table class='display table table-bordered' id='example' cellspacing='0' width='100%'>  
	    ...
	    <th style='width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;'>Sub&nbsp;Category</th>
		  <th style='width:11%;background-color:#454545; color:white; text-align:center; font-family:Times New Roman, Times, serif;'>Category</th>
	...
	";
		...
		$stmt=$dbcon->prepare('SELECT * FROM mis WHERE category_id=:cid ORDER BY department');
