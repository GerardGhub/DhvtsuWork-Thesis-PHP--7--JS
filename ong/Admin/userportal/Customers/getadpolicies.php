                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <!--h3 class="title" style="font-weight:bold; color:gray;">Finance Department Policy</h3-->  <h4 class="btn btn-primary" style="font-size:24px; background-color:#337ab7;width:1585px;"> <b class="fa fa-user" style="color:white;">&nbsp;&nbsp;Finance Department Policy and Procedure </b></h4>								   
...
$query=mysql_query("SELECT distinct category_id, item_id, item_image, policy_title, revisionno, img_name, department FROM operationdivisiondepartment WHERE category_id='$get_id'") or die (mysql_error());
