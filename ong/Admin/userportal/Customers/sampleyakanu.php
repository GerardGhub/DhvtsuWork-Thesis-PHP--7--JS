				...
				<a href="downloadsrere.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							...
							$num_rows = mysql_num_rows($result);
							?>
				<a href="downloadlogisticrere.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							...
							$num_rows = mysql_num_rows($result);
							?>
				<a href="downloadfinancerere.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                      <div class="left"></div>
                        <div class="right">
							...
							$num_rows = mysql_num_rows($result);
							?>
				<a href="downloadoperationrere.php">
                ...
                <div class="row tile_count" style="margin-right:-245px;">
					 <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							...
							$num_rows = mysql_num_rows($result);
							?>
				<a href="downloadgeneralservicesrere.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							...
							$num_rows = mysql_num_rows($result);
							?>
				<a href="downloadadministrativerere.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							...
							$num_rows = mysql_num_rows($result);
							?>
				<a href="downloadhumanresourcesrere.php">
