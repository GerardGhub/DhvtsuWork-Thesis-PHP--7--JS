                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Admininistrative Policy Manual(2017)</h2>
                                </div>
...
$query=mysql_query("SELECT * FROM ap LIMIT $start, $limit");
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='../item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<center><h4>  ".$query2['item_price']." </h4></center>
										...
										<a class='btn btn-block btn-danger' href='download-resultap.php'><span class='fa fa-cloud-download'></span>&nbsp;Download</a>
...
$rows=mysql_num_rows(mysql_query("SELECT * FROM ap "));
