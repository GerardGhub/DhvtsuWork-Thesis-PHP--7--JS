...
<div style="padding:0px" class="col-sm-12">
                                ...
                                <div class="panel panel-default text-center effect2 efbor">
                                	...
                                	<div style="margin:5px;" class="pull-right">
                                    	<button type="submit" class="btn btn-sm btn-danger efbor">
                                        <i class="glyphicon glyphicon-off"></i> Confirm Checkout</button> 
                        			</div>
    ...
    <table class="table table-bordered table-hover" id="example">
                ...
                <tbody class="tbody">
                    ...
                    <tr>
                        ...
                        <td>
                        	<a class="tooltip-top" title="Chose"><input name="checkout[]" type="checkbox" value="<?php echo $row['reservation_id'];?>" required="required" /></a>
                        </td>
                    </tr>
