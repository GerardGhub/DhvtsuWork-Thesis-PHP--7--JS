						...
						<th  style="color:blue; font-weight:bold;" width="5%"><center>&nbsp;<input type="checkbox" id = "chckHead" align="center"/></center></th>
								...
								<th style="font-weight:color; color:gray;" width="11%"><center> REVISION NO</center></th> 
									<th style="font-weight:bold; color:gray;" width="11%"> <center>CATEGORY ID</center></th> 
																		<th style="font-weight:bold; color:gray;" width="12%"><center> DATE ADDED</center></th> 
								<th style="color:gray; font-weight:bold;" width="48%"><center>D O W N L O A D S&nbsp;&nbsp;  O P T I O N S</center></th>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				 ...
				 <a class="btn btn-danger" href="download-resultmis.php" title="Click for Edit" onclick="return confirm('Are you sure you want to Download All in PDF?')">All in PDF <span class='glyphicon glyphicon-download'></span></a> 
	...
	<input type="submit" name="createpdf" value="Download as ZIP file" onclick="return confirm('Check Selected File that You want to Download as ZIP')"style="background:azure; border: 1px solid blue; border-radius:4px; font-size:15px; padding:7px; font-weight:regular; color:black;"> 	
