                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <!--h3 class="title" style="font-weight:bold; color:gray;">Finance Department Policy</h3-->  <h4 class="btn btn-primary" style="font-size:24px; background-color:#337ab7;width:1585px;"> <b class="fa fa-usser" style="color:white;">&nbsp;&nbsp;MIS Policy and Procedure  </b>	<br><td><b>
