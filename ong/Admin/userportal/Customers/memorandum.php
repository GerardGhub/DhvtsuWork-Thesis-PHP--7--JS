                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="glyphicon glyphicon-duplicate" style="font-size:20px;">M E M O R A N D U M</h2>
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['policy_title']."</textarea>
           ...
           <a class='fancybox-buttons' href='/adminportal/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['policy_title']."'>
	
					<img src='/adminportal/item_images/".$query2['item_image']."' class='img img-thumbnail'  style='width:350px;height:150px;' />
					</a>
					...
					<center><h4>  ".$query2['department']." </h4></center>
										...
										<a class='btn btn-block btn-danger' href='#'><span class='	glyphicon glyphicon-calendar'></span>&nbsp;".$query2['item_date']."</a>
