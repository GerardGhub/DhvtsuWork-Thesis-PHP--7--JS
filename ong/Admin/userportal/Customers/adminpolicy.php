...
<?php include('includes/apmemoleftsbarsady.php');?>  

                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <b> <h3 class="fa fa-users" style="font-size:23px;">Administrative Policy</b>								   
        ...
        $stmt = $dbcon->prepare('SELECT * FROM apcategory');
        $stmt->execute();
