...
<?php include('includes/financememoleftbar.php');?>  

                    <div class="main-page">
              
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h3 class="title">D O W N L O A D S <i style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $error; ?></i><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Finance Department</center></h3><!--a data-toggle="modal" data-target="#uploadModalcatmis"><i class="fa fa-plus-circle"></i> <span>Add Category Mis</span></a-->
	  ...
	  <form method="post">
				...
				<!--table cellpadding="8" cellspacing="1" border="1" width="50%" style="border:1px solid blue; font-size:18px; color:blue;"-->
						...
						<th  style="color:blue; font-weight:bold;" width="5%"><center>&nbsp;<input type="checkbox" id = "chckHead" align="center"/></center></th>
										<th style="color:gray; font-weight:bold;"><center>POLICY SUBJECT</center></th>
								<th style="font-weight:bold; color:gray;"><center>FILE NAME</center></th>
								<th style="font-weight:color; color:gray;"><center> REVISION NO</center></th> 
									<th style="font-weight:bold; color:gray;"> <center>CATEGORY ID</center></th> 
																		<th style="font-weight:bold; color:gray;"><center> DATE ADDED</center></th> 
							...
							?-->
									  <?php
include("config.php");
	$stmt = $DB_con->prepare('select * from financedepartment');
	$stmt->execute();
								...
								<td>
									<!--a style="text-decoration:none; font-family:cursive; margin-left: 20px;" href="downloadnew.php?filename=<?php echo $name;?>">
										...
										Download
														...
														<a class="btn btn-info" href="downloadnew.php?filename=<?php echo $name;?>" title="Click for Edit" onclick="return confirm('Are you sure you want to Download this Selected Policy?')">Download<span class='glyphicon glyphicon-download'></span></a> 
																												
				 <a class="btn btn-danger" href="download-resultfinance.php" title="Click for Edit" onclick="return confirm('Are you sure you want to Download All in PDF?')">Download All PDF <span class='glyphicon glyphicon-download'></span></a> 
	...
	<input type="submit" name="createpdf" value="Download as ZIP fie" onclick="return confirm('Check Selected File that You want to Download as ZIP')"style="background:azure; border: 1px solid blue; border-radius:4px; font-size:16px; padding:3px; font-weight:regular; color:black;"> 	
