...
<head>
    ...
    <title>&nbsp;<b>&nbsp;O&G Policy Management System <b></title>
...
$query=mysql_query("SELECT item_id, policy_title, item_image, revisionno, img_name, department FROM officepresident ORDER BY department LIMIT $start, $limit");
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['policy_title']."</textarea>
		...
		<a class='btn btn-block btn-danger' title='Download Selected Policy?' href='#'><span class='fa fa-cloud-download'></span>&nbsp;RevisionNo&nbsp;".$query2['revisionno']."</a>
							...
							<!--a class='btn btn-block btn-danger' href='download.php?file=../item_images/".$query2['item_image']."'><span class='fa fa-cloud-download'></span>&nbsp;".$query2['revisionno']."Download</a-->		
		...
		$stmt=$dbcon->prepare('SELECT item_id, item_image, policy_title, revisionno, img_name, department FROM officepresident WHERE category_id=:cid ORDER BY department');
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$policy_title."</textarea>
            ...
            <a class='fancybox-buttons' href='/adminportal/item_images/$img_name' data-fancybox-group='button' title='Page ".$id."- ".$policy_title."'>
					...
					<a class='btn btn-block btn-danger' title='Download Selected Policy?' href='#'><span class='fa fa-cloud-download'></span>&nbsp;RevisionNo&nbsp;".$row['revisionno']."</a>
								<!--a class='btn btn-block btn-danger' href='download-resultop.php'><span class='fa fa-cloud-download'></span>&nbsp;Download</a-->
