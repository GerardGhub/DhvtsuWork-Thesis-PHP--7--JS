                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                   <h3 class="title" style="font-weight:bold; color:gray;">Management Information System Policy</h3>								   
    	
        <h4>
        <select id="getProductsmasarap">
        <option value="showAll" selected="selected">Show All Department Sections</option>
        <?php
        require_once 'confeg.php';
        
        $stmt = $dbcon->prepare('SELECT * FROM miscategory');
        $stmt->execute();
...
{		
	...
	$("#getProductsmasarap").change(function()
	{				
