...
<?php include('includes/leftbaro.php');?>  

                    <div class="main-page">
              
                            <div class="row page-title-div">
                             
                                                      	<div class="alert alert-info" style="color:white;background-color:#008CBA; width:1618px;">
         <center><h4> <span class="fa fas-userss"></span> <b>MIS Department Downloads</b></h4></center>
	  ...
	  <form method="post">
				...
				<!--table cellpadding="8" cellspacing="1" border="1" width="50%" style="border:1px solid blue; font-size:18px; color:blue;"-->
						...
						<th  style="color:blue; font-weight:bold;" width="5%"><center>&nbsp;<input type="checkbox" id = "chckHead" align="center"/></center></th>
								...
								<th style="color:gray; font-weight:bold;" width="20%"><center>D O W N L O A D S&nbsp;&nbsp;  O P T I O N S</center></th>
							...
							?-->
									  <?php
include("config.php");
	$stmt = $DB_con->prepare('select * from mis');
	$stmt->execute();
								...
								<td>
									<!--a style="text-decoration:none; font-family:cursive; margin-left: 20px;" href="downloadnew.php?filename=<?php echo $name;?>">
										...
										Download
														...
														<a class="btn btn-info" href="downloadnew.php?filename=<?php echo $name;?>" title="Click for Download File" onclick="return confirm('Are you sure you want to Download this Selected Policy?')">JPEG File<span class='fa fa-download'></span></a> 
																												
				 <a class="btn btn-danger" href="download-resultmis.php" title="Click for Edit" onclick="return confirm('Are you sure you want to Download All in PDF?')">PDF File <span class='glyphicon glyphicon-download'></span></a> 
	...
	<input type="submit" name="createpdf" value="ZIP Files" onclick="return confirm('Check Selected File that You want to Download as ZIP')"style="background:skyblue; border: 1px solid blue; border-radius:5px; font-size:16px; padding:3px; font-weight:regular; color:black;"> 	
