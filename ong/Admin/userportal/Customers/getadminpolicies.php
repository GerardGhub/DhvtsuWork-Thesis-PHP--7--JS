                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                <h4 class="btn btn-primary" style="font-size:24px; background-color:#337ab7;width:1585px;"> <b class="fa fa-usser" style="color:white;">&nbsp;&nbsp;Administrative Policy and Procedure  </b>	<br><td><b>
								   <?php include('connect.php');
			$get_id=$_GET['id'];
          //  $cats=$row['Prepared_By'];
            $query7 = mysql_query("select * from apcategory where category_id='$get_id'") or die(mysql_error());
...
$query=mysql_query("SELECT distinct category_id, item_id, item_image, policy_title, revisionno, img_name, department,issuedate,effectivedate FROM administrativepolicy WHERE category_id='$get_id'") or die (mysql_error());
