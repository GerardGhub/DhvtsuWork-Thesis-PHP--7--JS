...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['policy_title']."</textarea>
           ...
           <a class='fancybox-buttons' href='../item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['policy_title']."'>
					...
					<center><h4>  ".$query2['dh']." </h4></center>
					
		
					
<a class='btn btn-block btn-danger' title='Download Selected Policy?' href='downloadmis.php?file=../item_images/".$query2['item_image']."'>Download&nbsp; <span class='fa fa-cloud-download'></span>".$query2['item_date']."</a>
