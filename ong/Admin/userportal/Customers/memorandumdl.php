	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				 ...
				 <a class="btn btn-danger" href="download-resultmemorandum.php" title="Click for Edit" onclick="return confirm('Are you sure you want to Download All in PDF?')">All in PDF <span class='glyphicon glyphicon-download'></span></a> 
