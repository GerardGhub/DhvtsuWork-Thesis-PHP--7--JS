                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
								  ...
								  background-color:#337ab7;width:1585px;"> <b class="fa fa-usser" style="color:white;">&nbsp;&nbsp;HR Department Policy and Procedure  </b>	<br><td><b>
								   <?php include('connect.php');
			$get_id=$_GET['id'];
          //  $cats=$row['Prepared_By'];
            $query7 = mysql_query("select * from hrcategory where category_id='$get_id'") or die(mysql_error());
...
$query=mysql_query("SELECT distinct category_id, item_id, item_image, policy_title, revisionno, img_name, department,issuedate,effectivedate FROM hrdepartment WHERE category_id='$get_id'") or die (mysql_error());
