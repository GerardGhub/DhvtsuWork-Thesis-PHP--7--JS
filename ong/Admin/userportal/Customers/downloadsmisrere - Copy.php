...
<?php include('includes/leftbaro.php');?>  
                    ...
                    <div class="main-page">
                            ...
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h3 class="title">D O W N L O A D S <i style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $error; ?></i><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MIS Department</center></h3><!--a data-toggle="modal" data-target="#uploadModalcatmis"><i class="fa fa-plus-circle"></i> <span>Add Category Mis</span></a-->
								...
								<td>
									<!--a style="text-decoration:none; font-family:cursive; margin-left: 20px;" href="downloadnew.php?filename=<?php echo $name;?>">
										...
										Download
														...
														<a class="btn btn-info" href="downloadnew.php?filename=<?php echo $name;?>" title="Click for Download File" onclick="return confirm('Are you sure you want to Download this Selected Policy?')"><span class='fa fa-paperclip'></span></a> 
																												
				 <a class="btn btn-danger" href="download-resultmis.php" title="Click for Edit" onclick="return confirm('Are you sure you want to Download All in PDF?')">Download All PDF <span class='glyphicon glyphicon-download'></span></a> 
