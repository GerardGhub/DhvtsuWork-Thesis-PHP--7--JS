...
<?php include('includes/xleftbar.php');?>  
...
$query=mysql_query("select * from ongusers LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
	...
	echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#008CBA;'>
            ...
            <center> 
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['fname']." ".$query2['lastname']."</textarea>
           ...
           <a class='fancybox-buttons' href='../item_images/".$query2['user_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['fname']." ".$query2['lastname']."'>
