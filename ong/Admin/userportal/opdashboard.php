...
<html lang="en">
    <head>
        ...
        <title>O&G Policy Management System | Dashboard</title>
        ...
        <div class="main-wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-container">
                    ...
                    <?php include('includes/opleftbar.php');?>  
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-primary" href="manageuser.php">
<?php 
$sql1 ="SELECT username from ongusers ";
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="manageusers.php">
<?php 
...
?>
                                            ...
                                            <span class="name">Department Officer</span>
...
?>
                                            ...
                                            <span class="name">O&G Department</span>
...
?>
                                            ...
                                            <span class="name">Download PDF </span>
