...
<html lang="en">
    <head>
        ...
        <title>Admin Policyt Portal</title>
...
@keyframes fadeIn {
    ...
    <body class="top-navbar-fixed">
        <div class="main-wrapper">
              <?php include('includes/usertopbardh.php');?>
            <div class="content-wrapper">
                <div class="content-container">

                    <?php include('includes/Userleftbardh.php');?>  
...
?>
                                    ...
                                    <!-- /.col-lg-3 col-md-3 col-sm-6 col-xs-12 -->
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat "style="background-color:green;" href="finance/financedash.php">
...
echo $yesterday;?-->
	 ...
	 <a rel="tooltip" class="btn btn-info <?php echo $row['breakline'];?>" href="finance/editprintfront.php?Memo_id=<?php echo $row['Memo_id']; ?>" title="Click for Edit" onclick="launchFullScreen(document.documentElement)"><span class="glyphicon glyphicon-search" style="font-size:17px; color:white;"></span></a> 
...
<table class="table">
  ...
  <tbody>
	 ...
	 <a rel="tooltip" class="btn btn-info" href="Manager/holidaymemo.php" title="Click for Edit" onclick="launchFullScreen(document.documentElement)"><span class="glyphicon glyphicon-search" style="font-size:17px; color:white;"></span></a> 
