...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li>  <a href="dashboard.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Dashboard</emp></span> </a>
									  		       ...
									  		       <li class="actsive">  <a href="home.php" style="font-size:17px;"><i class="fa fa-bullhorn"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Newsfeed</emp></span> </a></li>
				 ...
				 <li class="actisve">  <a href="friends.php" style="font-size:17px;"><i class="fa fa-child fa fa-wifi"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Contact Lists</emp></span> </a>	</li>
		 ...
		 <li class="active">  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>		</li>						
									  
									       <li>  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Groupchat Messenger</emp></span> </a></li>
