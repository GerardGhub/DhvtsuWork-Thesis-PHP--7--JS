                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
                                      <li>  <a href="dashboard.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Dashboard</span> </a></li>
...
?><strong>Total of Files: <?php echo htmlentities($totalsubjects);?></strong></tr></td></p></a>
                ...
                <!--button class="btn btn-success btn-md" name="item_save"></button-->
				 ...
				 <button type="button" class="btn btn-danger btn-md" data-dismiss="modal">Cancel</button>
							...
							<!-- Mediul Modal  karat kiki-->
        <div class="modal fade" id="uploadModalsamplexmemosubcatys" tabindex="-1" width="250" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
       <h2 style="color:white;" class="modal-title" id="myModalLabel"><center class="fa fa-users">&nbsp;Add New Updates</h2>
              </div>
              <!--div class="modal-body"-->
...
<?php
  include('connect.php');
                                    if (isset($_POST['submitsubcategorynews'])) {

                                        $id = $_POST['id'];
                                        $newlyupdate= $_POST['newlyupdate'];
                                         $error_resulutions = $_POST['error_resulutions'];
										 $date_updated = $_POST['date_updated'];

                         mysql_query("insert into updates
                          (id,newlyupdate,error_resulutions,date_updated) values ('$id','$newlyupdate','$error_resulutions','$date_updated')") 
                     or die(mysql_error());
                                            ?>

                                         
                                  <script type="text/javascript">
                                     alert("Newly Updated added succesfully");
...
<input type="hidden" id="username" name="id" value="<?php
                        $id = mysql_query("select MAX(id) as max_subcat_id from updates");                                       
                        $row = mysql_fetch_array($id);
                        echo $row['max_subcat_id'] + 1;                                       
                        ?>" class="input-xlarge" required/>

  <div class="form-group">
 
      <input type="text" name="newlyupdate" class="form-control" placeholder="Newly Update" id="inputEmail3" required/>
	...
	<div class="form-group">
      ...
      <input type="text" name="error_resulutions" class="form-control" placeholder="Error Resolutions" id="inputEmail3" required/>
	...
	<div class="form-group">
      ...
      <input type="date" name="date_updated" class="form-control" placeholder="Date of Updated" id="inputEmail3" required/>
              ...
              <div class="modal-footer">
                ...
                <!--button class="btn btn-success btn-md" name="item_save">Save</button-->
				   <button type="submit" name="submitsubcategorynews" class="btn btn-success">Submit</button>
