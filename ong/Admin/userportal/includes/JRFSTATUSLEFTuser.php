...
<div class="left-sidebar bg-black-300 box-shadow ">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
                                     	    ...
                                     	    <li style="background-color:brown;">  <a href="managefinance.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Main Dashboard</span> </a></li>
			...
			$connection=mysqli_connect('localhost','root','','srms');
					...
					<li class="sactive"><a href="JRFhistory.php" style="font-size:17px;"><i class="fa fa-list">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request History</span><b>&nbsp;<emp style="background-color:brown; border-radius:20px;width:40px;">
						 <!--?php include('connect.php');-->
						 <?php 
			$connection=mysqli_connect('localhost','root','','srms');
