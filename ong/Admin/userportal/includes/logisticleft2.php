...
<div class="left-sidebar bg-black-300 box-shadow ">
		...
		<li class="actsve">  <a href="message.php" style="font-size:17px;"><i class="fa fa-envelope-o"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Read Message</emp></span> </a>				 
		 ...
		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									  ...
									  <li class="active">  <a href="logisticmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-certificate"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Logistic Msgr Reports</emp></span> </a>
									  
									  
									  
									  <li>  <a href="financemsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-ban-circle"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Finance Msgr Reports</emp></span> </a>
