...
<div class="left-sidebar bg-black-300 box-shadow ">
					...
					<p style="text-align:center;"><img class="img-circle" src="item_images/<?php echo $_SESSION['sess_user_image'];?>" height="100" width="180" /></p>
						 ...
						 <li><a data-toggle="modal"  title="Notifications" data-target="#orgchart" style="font-size:17px;"><i class="glyphicon glyphicon-th-list" style="color:white;">&nbsp;</i> <span>Organizational Chart </span> <!--o class="fa fa-angle-right arrow"></o--></a></li>
                                      ...
                                      <li><a href="Manager/viewmemorandum.php" style="font-size:17px;"><i class="	fa fa-paper-plane-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Memorandum </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
       ...
       <li><a href="manager/JRFPAGE.php" style="font-size:17px;"><i class="fa fa-tv"></i> <span>&nbsp;&nbsp;Job Request Form</span> <!--i class="fa fa-angle-right arrow"></i--></a></li>  

									
       <li><a href="Manager/allsharedfiles.php" style="font-size:17px;"><i class="fa fa-users"></i> <span>&nbsp;&nbsp;O&G &nbsp;Shared&nbsp;Files</span> <i class="fa fa-angle-righst arrowd"></i></a></li>       	   
								  
				

		   <li><a href="#../finance/onggallery.php" style="font-size:17px;"><i class="glyphicon glyphicon-copy"></i> <span>&nbsp;&nbsp;&nbsp;Stock Level Monitoring</span> <i class="#"></i></a></li>
       ...
       <!--li><a href="../admin/misdashboardfinaljob.php" style="font-size:17px;"><i class="fa fa-info"></i> <span>&nbsp;&nbsp;MIS</span> <i class="#"></i></a></li-->
			   ...
			   <li><a href="Manager/onggallery.php" style="font-size:17px;"><i class="glyphicon glyphicon-picture"></i> <span>&nbsp;&nbsp;&nbsp;O&G Gallery Events</span> <i class="#"></i></a></li>
       ...
       <li><a href="Manager/managefile.php" style="font-size:17px;"><i class="glyphicon glyphicon-floppy-disk"></i> <span>&nbsp;&nbsp;Department File Manager</span> <i class="#"></i></a></li>
									 
	   
	  								
       <li><a href="Manager/Messenger.php" style="font-size:17px;"><i class="glyphicon glyphicon-envelope" ></i> <span>&nbsp;&nbsp; O&G Messenger</span> <i class="#"></i></a></li>
									 
				     <li><a href="Manager/activeuserlogs.php" style="font-size:17px;"><i class="glyphicon glyphicon-user" ></i> <span>&nbsp;&nbsp;User Department Logs</span> <i class="#"></i></a></li>
									 
			
    <li><a href="Manager/activeuserlogs.php" style="font-size:17px;"><i class="glyphicon glyphicon-user" ></i> <span>&nbsp;&nbsp;My PortFolio</span> <i class="#"></i></a></li>


			
       <li><a data-toggle="modal"  title="Notifications" data-target="#mis" href="#Customers/memorandum.php" style="font-size:17px;"><i class="fa fa-info-circle"></i> <span>&nbsp;&nbsp;About Us Developer</span> <i class="fa fa-heart"></i></a></li>
...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
				...
				<img src="item_images/orgchart.jpg" width="1620" height="900">
											...
											<!-- Mediul Modal kiki-->
        <div class="modal fade" id="mis" tabindex="-1" width="350" role="dialog" aria-labelledby="myMediulModalLabel">
      p;<div class="modal-dialog modal-md" style="width:1370px;position:absolute:right:50px;">
            <div style="color:white;background-color:white;" class="modal-content">
			        <!--div style="color:white;background-color:#008CBA" class="modal-content"-->
              <!--div class="modal-header">
...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
				...
				<img src="../item_images/misteam.jpg" width="1620" height="900">
