...
?-->
  	...
  	<li style="color:black;"><a data-toggle="modal"  title="Notifications" data-target="#aUpdateInformation" data-toggle="modal"class="color-primary text-center " osnclick="return confirm('Update a UserInformation <?php echo $_SESSION['sess_username'];?> ?')"><i class="fa fa-bell" style="color:grey;">&nbsp;</i> </a></li>					
