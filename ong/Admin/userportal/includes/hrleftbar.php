                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="managehr.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span>  </a>
   ...
   <li class="has-children">
     ...
     <li>
									  ...
									  <!--li><a href="dito/librarian/add_books.php"><i class="fa fa fa-server"></i> <span> Add MIS</span></a></li-->
                                        ...
                                        <ul class="child-nav">
										  <li> <a href="managecathr.php"><i class="fa fa-file-text"></i> <span>Manage Category Record</span> <i class="#"></i></a>
			<li><a href="managepolicyhr.php"><i class="fa fa-file-text"></i> <span> Manage Policy Records</span></a></li>
			<li><a href="managefilehr.php"><i class="glyphicon glyphicon-stats"></i> <span>File Manager</span></a></li>
						                                          <li><a href="../Customers/hrd.php"><i class="fa fa fa-search"></i> <span>View HR Policy</span></a></li>
