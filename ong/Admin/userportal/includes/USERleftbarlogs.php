...
<div class="left-sidebar bg-black-300 box-shadow ">
       ...
       <li><a href="JRFPAGE.php" style="font-size:17px;"><i class="fa fa-tv"></i> <span>&nbsp;&nbsp;Job Request Form</span> <!--i class="fa fa-angle-right arrow"></i--></a></li>  

									
       <li><a href="#Customers/memorandum.php" style="font-size:17px;"><i class="fa fa-users"></i> <span>&nbsp;&nbsp;Employee Gatepass</span> <i class="fa fa-angle-right arrow"></i></a></li>       	   
       ...
       <!--li><a href="../admin/misdashboardfinaljob.php" style="font-size:17px;"><i class="fa fa-info"></i> <span>&nbsp;&nbsp;MIS</span> <i class="#"></i></a></li-->
			   ...
			   <li><a href="../finance/onggallery.php" style="font-size:17px;"><i class="glyphicon glyphicon-picture"></i> <span>&nbsp;&nbsp;&nbsp;Manpower Gallery</span> <i class="#"></i></a></li>
       ...
       <li><a href="../humanresources/hrddashboard.php" style="font-size:17px;"><i class="fa fa-info"></i> <span>&nbsp;&nbsp;HR Department</span> <i class="#"></i></a></li>
									


	  								
       <li><a href="managefilefinance.php" style="font-size:17px;"><i class="glyphicon glyphicon-floppy-disk"></i> <span>&nbsp;&nbsp;Finance File Manager</span> <i class="#"></i></a></li>
									 
	   
	  								
       <li><a href="Messenger.php" style="font-size:17px;"><i class="glyphicon glyphicon-envelope" ></i> <span>&nbsp;&nbsp;Face OG Messenger</span> <i class="#"></i></a></li>
       ...
       <li><a href="#Customers/memorandum.php" style="font-size:17px;"><i class="fa fa-info-circle"></i> <span>&nbsp;&nbsp;Gerard Singian</span> <i class="fa fa-angle-right arrow"></i></a></li>
...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
  ...
  <div class="form-group" style="background-image: url("..\item_images\amazing.gif");">
   <center><img src="..\item_images\Userspics\<?php echo $_SESSION['sess_user_image'];?>" width="150" height="140" ></center><center><emp class="btn btn-dangers" style="font-size:24px;color:whitesmoke;"> <center> Message Notifications</center> </emp></center>
