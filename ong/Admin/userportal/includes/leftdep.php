...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li>  <a href="managefinance.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Main Dashboard</emp></span> </a>
									   ...
									   <li class="actdive">  <a href="Messenger.php" style="font-size:17px;"><i class="fa fa-list"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Messenger Dashboard</emp></span> </a>
      ...
      <li class="active">  <a href="Groupmessengerdep.php" style="font-size:17px;"><i class="fa fa-user"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Department Groupchat</emp></span> </a>														<!--td style="text-align:center;">
