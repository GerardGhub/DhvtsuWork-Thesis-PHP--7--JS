...
<li>
                                      ...
                                      <li><a href="../userportal/Customers/gallerycount.php" style="font-size:17px;"><i class="glyphicon glyphicon-picture">&nbsp;</i> <span>My Gallery </span> <!--o class="fa fa-angle-right arrow"></o--></a></li>
