                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
                                      <li>  <a href="../userdashboard.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Dashboard</span> </a></li>
									  
									  <li>
									    <a rel="tooltip" class="btn btn-infod" style="border-color:skyblue;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" onclick="return confirm('Are you sure you want to Add a New Data?')" a data-toggle="modal" data-target="#uploadModalsamplexmemosuperjeje" data-toggle="modal"    class="btn btn-light"><span class="
glyphicon glyphicon-cloud-upload" style="text-align:center; color:white"></span><i class="icon-trash icon-large"></i>&nbsp;Upload New Documents</a></li>
...
$query=$conn->query("INSERT INTO filemgrfinance (item_image,item_date,upload_by,department) VALUES ('$name','$date','$upload_by','$department')");
if($query){
	
 echo "<script>window.open('managefile.php','_self')</script>";
