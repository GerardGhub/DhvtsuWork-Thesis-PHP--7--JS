		 ...
		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									       ...
									       <li>  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Public Groupchat</emp></span> </a>
									        ...
									        <li class="actiave">  <a href="staffdbdashboard.php" style="font-size:17px;"><i class="fa fa-database"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;MIS Msgr Reports</emp></span> </a>
													...
													<li class="active">  <a href="jrfmftgdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-equalizer"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Manufacturing Reports</emp></span> </a>
													
														<li>  <a href="gsmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-copy"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;GS Msgr Reports</emp></span> </a>
														
													
									  
									  <li>  <a href="logisticd=msgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-certificate"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Logistic Msgr Reports</emp></span> </a>
									  ...
									  <li>  <a href="gsmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-gift"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;HR Msgr Reports</emp></span> </a>
