...
<div class="left-sidebar bg-black-300 box-shadow ">
				 ...
				 <li class="active">  <a href="friends.php" style="font-size:17px;"><i class="fa fa-child fa fa-wifi"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Contact Lists</emp></span> </a>	
		 ...
		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									       ...
									       <li>  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Groupchat Messenger</emp></span> </a>
