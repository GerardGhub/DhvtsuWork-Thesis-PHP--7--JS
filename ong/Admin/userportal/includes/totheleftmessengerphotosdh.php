...
<div class="left-sidebar bg-black-300 box-shadow ">
		 ...
		 <li class="active">  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Personal Photos</emp></span> </a>		</li>						
									  
									       <li>  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Public Messenger</emp></span> </a></li>
