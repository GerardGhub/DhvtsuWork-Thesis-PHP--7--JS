...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
										 ...
										 <!--a href="Customers/sampleyamu.php"><i class="fa fa-download"></i> <span>Downloads</span> </a-->
                                     	    <li style="background-color:brown;">  <a href="dashboard.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Main Dashboard</span> </a></li>
                    ...
                    <li class="actisve"><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemojrf" style="font-size:17px;"><i class="	fa fa-paper-plane-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Create New Job Request </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
							 ...
							 <li class="actsive"><a href="JRFPAGE.php" style="font-size:17px;"><i class="	fa fa-star">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request Overall </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>			
										
                           <!--li><a href="viewmemorandum.php" style="font-size:17px;"><i class="fa fa-sitemap">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Release New Memorandum</span> <!--o class="#fa fa-angle-right arrow"></o--></a></li-->
						 ...
						 <!--o class="fa fa-angle-right arrow"></o--><!--/a></li-->
						 
						 
						 
						 
						 	  
									     <!--li class="#active"><a href="viewmemosubjects.php" style="font-size:17px;"><i class="	fa fa-envelope">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Subject&nbsp;Memorandum </span-->
						 ...
						 <li class="active"><a href="JRFREQUEST.php?id=<?php echo $row['37']; ?>" style="font-size:17px;"><i class="	fa fa-users">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>JRF Status </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
						 		 ...
						 		 <li class="#active"><a data-toggle="modal" href="#JRFREQUEST.php" data-target="#Uploadmemojrfull" style="font-size:17px;"><i class="	fa fa-tv">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request SampLe </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
						 			 ...
						 			 <li class="#active"><a href="JRfdashboard.php" style="font-size:17px;"><i class="	fa fa-headphones">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>IT Department Tracking </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
									 
									 
						 			 <li class="#active"><a href="JRfdashboardmftg.php" style="font-size:17px;"><i class="	fa fa-ticket">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>MFTG Reports </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
						 						 
									 <li class="#active"><a href="JRfdashboardgsd.php" style="font-size:17px;"><i class="	fa fa-trophy">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>General Services Reports </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>		 
									 
									 <li class="#active"><a href="JRfdashboardlogistic.php" style="font-size:17px;"><i class="	fa fa-star-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Logistic&nbsp;Reports </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>		 
									 	
									 
									 
									 		 <li class="#active"><a href="JRfdashboardfinance.php" style="font-size:17px;"><i class="	fa fa-support">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Finance&nbsp;Reports </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>		 
									 	
										
												 <li class="#active"><a href="JRfdashboardhrdo.php" style="font-size:17px;"><i class="	fa fa-user-plus">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>HR&nbsp;Reports </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>		 
									 	
										
										
												 <li class="#active"><a href="JRfdashboardop.php" style="font-size:17px;"><i class="	fa fa-dollar">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>OP&nbsp;Reports </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>		 
			...
			$connection=mysqli_connect('localhost','root','','srms');
						 ...
						 $count_query = mysqli_query($connection,"Select * from jobrequestfinalactivity") or die (mysqli_error());
				 ...
				 <li class="#active"><a href="JRFhistory.php" style="font-size:17px;"><i class="fa fa-pencil">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request History</span><b>&nbsp;<emp style="background-color:brown; border-radius:20px;width:40px;">
						 <!--?php include('connect.php');-->
						 <?php 
			$connection=mysqli_connect('localhost','root','','srms');
						 
						 $department=$_SESSION['sess_department'];
						 $count_query = mysqli_query($connection,"Select * from jobrequestfinalhistory") or die (mysqli_error());
						 $count = mysqli_num_rows($count_query);
						 ?>
						 <?php echo $count;?>
						 ...
						 </emp></b> <!--o class="#fa fa-angle-right arrow"></o--></a></l
						 			 ...
						 			 <li class="#active"><a href="#JRFREQUEST.php" style="font-size:17px;"><i class="	fa fa-calendar">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request DTPicker </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
