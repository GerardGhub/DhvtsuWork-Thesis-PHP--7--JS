...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
										 ...
										 <!--a href="Customers/sampleyamu.php"><i class="fa fa-download"></i> <span>Downloads</span> </a-->
                                     	    <li>  <a href="dashboard.php" onclick="goBack()" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Dashboard</span> </a></li>
                    ...
                    <li class="active"><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemojrf" style="font-size:17px;"><i class="	fa fa-paper-plane-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Create New Job Request </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
