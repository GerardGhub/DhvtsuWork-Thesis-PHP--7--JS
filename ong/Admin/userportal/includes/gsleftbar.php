   ...
   <li class="has-children">
     ...
     <li>
									  ...
									  <!--li><a href="dito/librarian/add_books.php"><i class="fa fa fa-server"></i> <span> Add MIS</span></a></li-->
                                        ...
                                        <ul class="child-nav">
					  <li> <a href="managecatgs.php"><i class="fa fa-file-text"></i> <span>Manage Category Record</span> <i class="#"></i></a></li>
<li><a href="managepolicygs.php"><i class="fa fa-file-text"></i> <span> Manage Policy Records</span></a></li>
	    <li><a href="managefilegs.php"><i class="glyphicon glyphicon-stats"></i> <span>File Manager</</span></a></li>
										                                          <li><a href="../Customers/sg2.php"><i class="fa fa fa-search"></i> <span>View GS Policy</span></a></li>
