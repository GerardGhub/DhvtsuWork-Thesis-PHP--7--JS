...
<div class="left-sidebar bg-black-300 box-shadow ">
					...
					<p style="text-align:center;"><img class="img-circle" src="../item_images/<?php echo $_SESSION['sess_user_image'];?>" height="100" width="180" /></p>
                            ...
                            <div class="sidebar-nav">
                                ...
                                <li>  <a href="../userdashboard.php" style="font-size:17px; background-color:brown;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Main Dashboard</span> </a></li>
                    ...
                    <li class="actisve"><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemojrf" style="font-size:17px;"><i class="	fa fa-paper-plane-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Create New Job Request </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
											 ...
											 <li class="activae"><a href="JRFPAGE.php" style="font-size:17px;"><i class="	fa fa-star">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request Overall </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
						 ...
						 <li class="aactive"><a href="JRFLIST.php" style="font-size:17px;"><i class="	fa fa-envelope">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request Created List </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
  ...
  <div class="form-group" style="background-image: url("..\item_images\amazing.gif");">
   <center><img src="..\item_images\<?php echo $_SESSION['sess_user_image'];?>" width="110" height="110"></center><center><emp class="btn btn-dangers" style="font-size:24px;color:whitesmoke; padding-top:5px;width:210px;height:34px;text-align:center;"> <?php echo $_SESSION['sess_fname'];?> &nbsp;<?php echo $_SESSION['sess_lastname'];?>  </emp></center>
              ...
              <div class="modal-footer">
                ...
                <!--button class="btn btn-success btn-md" name="item_save">Save</button-->
				 ...
				 <button type="button" class="btn btn-danger btn-md" data-dismiss="modal">Cancel</button>
								...
								<!-- Mediul Modal kiki-->
        <div class="modal fade" id="Viewmemojrf" tabindex="-1" width="250" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md" style="width:930px;">
            <div style="color:white;background-color:white" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
&nbsp; MIS&nbsp;Dev&nbsp;Code___________________
  ...
  <tr>
    <td><textarea rows="4" cols="70" name="JobReq" required></textarea><?php echo $JobReq;?></td>
...
<i>(this portion is to be accomplished by MIS who will attend the request)</i>
 ...
 <tr>
 <th colspan="3" style="border-top:outset; text-align:center;"> Actions Taken / Remarks</th>
 </tr>
 <tr>
    <td colspan="3" style="border-bottom: 1px solid whitesmoke; border-left: 1px solid whitesmoke;border-right: 1px solid whitesmoke;">
<textarea input type="text" name="gago" rows="3" cols="140" placeholder="(Please indicate parts replaced or switched or transfered, if any. MIRS number is stated if requested parts are from Warehouse Section)" id="tang ina" readonly></textarea>
