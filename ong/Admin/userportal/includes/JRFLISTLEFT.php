...
<div class="left-sidebar bg-black-300 box-shadow ">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
                                      ...
                                      <!--li>  <a href="managefinance.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Dashboard</span> </a></li-->
                    ...
                    <li class="aaactive"><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemojrf" style="font-size:17px;"><i class="	fa fa-paper-plane-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Create New Job Request </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
...
?>
 ...
 (JRFno,Date_now,Type,Name,Department,JobReq,Purpose,Typeothers,Preparedby,Status) values
     ('$JRFno','$Date_now','$Type','$Name','$Department','$JobReq','$Purpose','$Typeothers','$Preparedby','For Approval')") or die(mysql_error());
