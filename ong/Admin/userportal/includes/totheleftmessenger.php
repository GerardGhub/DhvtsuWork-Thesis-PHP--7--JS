                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li>  <a href="managefinance.php" style="font-size:17px;background-color:brown; background-color:browns;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp">&nbsp;&nbsp;Main Dashboard</emp></span> </a>
