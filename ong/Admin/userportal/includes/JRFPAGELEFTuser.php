        ...
        <div class="modal fade" id="Uploadmemojrf" tabindex="-1" width="250" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md" style="width:930px;">
            <div style="color:white;background-color:white" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
     <!--img src="../item_images/GerardSs.jpg" width="120"><b style="color:black; text-align:center;">Job Request Form</b></img--> <h3 style="color:black;text-align:center; font-size:25px;" class="modal-title" id="myModalLabel"><center class="#">&nbsp;Job Request Form</center> <center style="color:black;"><h4 style="font-size:17px">(<b>MIS</b>)
              </h3>
...
<table class="table table-bordered table-responsive">
  ...
  <tr>
	...
	<form> <td style="font-size:13px; width:24%;">
