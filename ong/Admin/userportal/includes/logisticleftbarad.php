...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="nav-header">
                                        <span class="">Appearance</span>
										    ...
										    <li><a href="managelogistic.php"><i class="glyphicon glyphicon-stats"></i> <span style="font-size:17px;">&nbsp;&nbsp;Logistic Monitoring</</span></a></li>
		   ...
		   <a data-toggle="modal" data-target="#uploadModalcategorymissection"><i class="fa fa-star"></i> <span style="font-size:17px;">New Dep_Section </span> <i class="#"></i></a>  
										   ...
										   <a data-toggle="modal" data-target="#uploadModalcategorymis"><i class="fa fa-star"></i> <span>Add New Subject </span> <i class="#"></i></a>
										      <a data-toggle="modal" data-target="#uploadModalsamplex"><i class="fa fa-star"></i> <span>Add New Logistic</span> <i class="#"></i></a>
   ...
   <li class="has-children">
     ...
     <li>
									  ...
									  <!--li><a href="dito/librarian/add_books.php"><i class="fa fa fa-server"></i> <span> Add MIS</span></a></li-->
                                        ...
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Select Logistic Policy </span> <i class="fa fa-angle-right arrow"></i></a>
										
                                        <ul class="child-nav">
									 <li>  <a href="managecatlogistic.php"><i class="fa fa-file-text"></i> <span>Manage Subject</span> <i class="#"></i></a></li>
										
<!--li><a href="managepolicyld.php"><i class="fa fa-file-text"></i> <span> Manage Policy</span></a></li-->
							
	<li><a href="viewlogisticpolicy.php"><i class="fa fa-star"></i> <span>Policy Monitoring</span></a></li>									
										
										
										
				    <li><a href="managesectionlogistic.php"><i class="glyphicon glyphicon-stats"></i> <span style="font-size:17px;">&nbsp;&nbsp;Logistic Sections</</span></a></li>
															
							    <li><a href="../Customers/memorandumlde.php"><i class="fa fa fa-search"></i> <span>View Logistic</span></a></li>
...
<!-- Mediul Modal -->
				 ...
				 <form enctype="multipart/form-data" method="post" action="addpolicylogistic.php">
                   <fieldset>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <input class="form-control" placeholder="Subject" value="gerardsingian" name="policy_title" type="text">
						   ...
						   <?php
						   include('dbcon.php');
			$cat_query = mysql_query("SELECT * FROM logisticcategory order by timestamp DESC ");
	...
	<option value="<?php echo $cat_row['category_id']; ?>"><?php echo $cat_row['classname']; ?></option>
			<?php  } ?>
                        ...
                        <input id="priceinput" class="form-control" value="Logistic Department" name="department" readonly="readonly" type="text"required>
            ...
            <input id="priceinput" class="form-control" placeholder="ULOL" name="uploadbyimg" value="<?php echo $_SESSION['sess_user_image'];?>" type="text" >
        ...
        <div class="modal fade" id="uploadModalcategorymis" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h2 style="color:white" class="modal-title" id="myModalLabel"><center>Add New Logistic Subject</center></h2>
              </div>
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="post" action="addcategorylogistic.php">
                   <fieldset>
						   ...
						   <?php
						   include('dbcon.php');
			$cat_query = mysql_query("SELECT * FROM logisticdepfinal");
			while($cat_row = mysql_fetch_array($cat_query)){
			?>
	<option value="<?php echo $cat_row['category_id']; ?>"><?php echo $cat_row['classname']; ?></option>
			<?php  } ?>
	 ...
	 <form enctype="multipart/form-data" method="post" action="adddepartmentsectionlogistic.php">
                   <fieldset>
