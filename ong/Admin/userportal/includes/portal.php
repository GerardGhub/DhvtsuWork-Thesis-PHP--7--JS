...
<div class="left-sidebar bg-black-300 box-shadow ">
 ...
 <li class="has-children">
                                      ...
                                      <a href="#" style="font-size:17px;"><o class="glyphicon glyphicon-user">&nbsp;</o> <span>Applicant List</span> <o class="fa fa-angle-right arrow"></o></a>
										
                                        <ul class="child-nav">
										
																													   
				   <a href="myreserved.php"><i class="glyphicon glyphicon-briefcase"></i> <span style="font-size:17px;">&nbsp;Reserved</span> <i class="#"></i></a>
						
							  	  	  
									  
									  
									  
									  <a href="mypassed.php"><i class="glyphicon glyphicon-book"></i> <span style="font-size:17px;">&nbsp;Passed</span> <i class="#"></i></a>
					
									  <a href="mynotqualified.php"><i class="fa fa-heart"></i> <span style="font-size:17px;">&nbsp;Not Qualified</span> <i class="#"></i></a>
							
										
									  
									  <a href="#backup.php"><i class="fa fa-database"></i> <span style="font-size:17px;">&nbsp;Processed</span> <i class="#"></i></a>
				...
				<!--li class="active">
                                      ...
                                      <a href="onginternal.php" style="font-size:17px;"><o class="glyphicon glyphicon-envelope">&nbsp;</o> <span>Inbox </span> <!--o class="fa fa-angle-right arrow"--><!--/o></a>
									  </li-->
									  	<li class="active">
				
				
                                      <a href="myinbox.php" style="font-size:17px;"><o class="glyphicon glyphicon-envelope">&nbsp;</o> <span>Inbox </span> <!--o class="fa fa-angle-right arrow"--></o></a>
									  </li>
				   ...
				   <a href="postedlist.php"><i class="glyphicon glyphicon-briefcase"></i> <span style="font-size:17px;">&nbsp;Posted Job</span> <i class="#"></i></a>
				
							  	  	  
									  
									  
									  
									  <a href="joblist.php"><i class="glyphicon glyphicon-book"></i> <span style="font-size:17px;">&nbsp;Job List</span> <i class="#"></i></a>
					
									  <a href="#storage.php"><i class="fa fa-server"></i> <span style="font-size:17px;">&nbsp;Activity Logs</span> <i class="#"></i></a>
