...
<div class="left-sidebar bg-black-300 box-shadow ">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
                                      <li>  <a href="managefinance.php" style="font-size:17px;"><i class="fa fa-dadshboard"></i> <span></span> </a></l1i>
                    ...
                    <li class="active"><a href="managefinance.php" style="font-size:17px;"><i class="	fa fa-dashboard">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Dashboard&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
