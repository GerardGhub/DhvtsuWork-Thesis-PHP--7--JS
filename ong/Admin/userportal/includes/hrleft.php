...
<div class="left-sidebar bg-black-300 box-shadow ">
					...
					<p style="text-align:center;"><img class="img-circle" src="../userportal/item_images/userspics/<?php echo $_SESSION['sess_user_image'];?>" height="100" width="180" /></p>
                                                     <h6 class="title"><?php echo $_SESSION['sess_fname'];?>&nbsp;<?php echo $_SESSION['sess_lastname'];?></h6> 
                                <small class="info">O&G Leather Mftg Corp</small>
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    <li class="nav-header">
                                        <span><emp class="" style="color:whitsse;">Main Category</emp></span>
                                    </li>
                                    <li style="font-size:20px;">
                                      <li>  <a href="dashboard.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Dashboard</emp></span> </a>
									  
									  
									  		       <li>  <a href="home.php" style="font-size:17px;"><i class="fa fa-bullhorn"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Newsfeed</emp></span> </a>
									  
									      <li class="activse">  <a href="Messenger.php" style="font-size:17px;"><i class="fa fa-list"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Messenger Dashboard</emp></span> </a>
									  
									  
				 <li>  <a href="friends.php" style="font-size:17px;"><i class="fa fa-child fa fa-wifi"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Contact Lists</emp></span> </a>	

					  
				 <li class="actsve">  <a href="message.php" style="font-size:17px;"><i class="fa fa-comments-o"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Message</emp></span> </a>
		
		<li class="actsve">  <a href="message.php" style="font-size:17px;"><i class="fa fa-envelope-o"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Read Message</emp></span> </a>				 
									  
							
				<li class="actsve">  <a href="message.php" style="font-size:17px;"><i class="fa fa-send"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Sent Items</emp></span> </a>						
							
													<li class="actsve">  <a href="msgreported.php" style="font-size:17px;"><i class="fa fa-warning"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Message Reported</emp></span> </a>		
							
							

		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									  
									       <li>  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Public Groupchat</emp></span> </a>
										   
										   
										      <li>  <a href="Groupmessengerdep.php" style="font-size:17px;"><i class="fa fa-user"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Department Groupchat</emp></span> </a>
									  
									        <li class="actiave">  <a href="staffdbdashboard.php" style="font-size:17px;"><i class="fa fa-database"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;MIS Msgr Reports</emp></span> </a>
											        
													<li class="activ4e">  <a href="jrfmftgdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-equalizer"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Manufacturing Reports</emp></span> </a>
													
														<li class="act3ive">  <a href="gsmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-copy"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;GS Msgr Reports</emp></span> </a>
														
													
									  
									  <li class="actisve">  <a href="logisticmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-certificate"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Logistic Msgr Reports</emp></span> </a>
									  
									  
									  
									  <li class="actisve">  <a href="financemsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-ban-circle"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Finance Msgr Reports</emp></span> </a>
									  
									  
									  
									  
									  <li class="active">  <a href="hrmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-gift"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;HR Msgr Reports</emp></span> </a>
									  
									  
									  
									  
									  <li>  <a href="opmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-plane"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;OP Msgr Reports</emp></span> </a>
									  
									  <li>  <a href="#Staffdbdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-print"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Printing Reports</emp></span> </a>	  
	 ...
	 <center class="zoom"> <img src="../item_images/rematch.png" class="img img-rounded"  width="370" height="110"/></center>
						 ...
						 <!--li><a data-toggle="modal"  title="Notifications" data-target="#orgchart" style="font-size:17px;"><i class="glyphicon glyphicon-th-list" style="color:white;">&nbsp;</i> <span>Organizational Chart </span> <!--o class="fa fa-angle-right arrow"></o--><!--/a></li-->
                                      ...
                                      <!--li class="active"><a href="viewmemorandum.php" style="font-size:17px;"><i class="	fa fa-paper-plane-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Memorandum </span> </a></li>
								
						
										
										
						 <li><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemo" style="font-size:17px;"><i class="fa fa-plus" style="color:white;">&nbsp;</i> <span>Release New Memorandum </span> 
						 
						 
						 
						 	  
									     <li class="#active"><a href="viewmemosubjects.php" style="font-size:17px;"><i class="	fa fa-envelope">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Subject&nbsp;Memorandum </span> </a></li>
						 	 ...
						 	 <li><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemo" style="font-size:17px;"><i class="fa fa-plus" style="color:white;">&nbsp;</i> <span>New Subject Memorandum </span--> 
       ...
       <!--li><a href="Customers/memorandum.php" style="font-size:17px;"><i class="fa fa-info-circle"></i> <span>&nbsp;&nbsp;O&G Memorandum</span> <i class="fa fa-angle-right arrow"></i></a></li-->
...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
  ...
  <div class="form-group" style="background-image: url("..\item_images\amazing.gif");">
   <center><img src="..\userportal\item_images\userspics\<?php echo $_SESSION['sess_user_image'];?>"></center><center><emp class="btn btn-dangers" style="font-size:24px;color:whitesmoke; padding-top:5px;width:210px;height:34px;text-align:center;"> <?php echo $_SESSION['sess_fname'];?> &nbsp;<?php echo $_SESSION['sess_lastname'];?>  </emp></center>
...
$query=$conn->query("INSERT INTO filemgrfinance (item_image,item_date,upload_by,department) VALUES ('$name','$date','$upload_by','Finance Department')");
if($query){
   ...
   font-size: 20px;
	...
	<!--div class="alert alert-info">
			...
			<td><form enctype="multipart/form-data" action="" id="wb_Form1" name="form" method="post">
					...
					<input type="text" name="upload_by" value="<?php echo $_SESSION['sess_fname'];?>&nbsp;<?php echo $_SESSION['sess_lastname'];?>">
					</td>
				
					
					<!--td><input type="submit" class="btn btn-danger" value="SUBMIT" name="submitlaaarnie">
			<a style="color:gray; font-size:23px; padding-top: 90px;"><?php 
