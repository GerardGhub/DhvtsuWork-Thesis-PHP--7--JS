...
<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="adminmanageappolicy.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
										   ...
										   <a data-toggle="modal" data-target="#uploadModalcategoryap"><i class="fa fa-plus-circle"></i> <span>Add New Category </span> <i class="#"></i></a>
										      <a data-toggle="modal" data-target="#uploadModalsamplex"><i class="fa fa-plus-circle"></i> <span>Add New Administrative</span> <i class="#"></i></a>
     ...
     <li>
                                        ...
                                        <ul class="child-nav">
								   <li><a href="managecatap.php"><i class="fa fa-file-text"></i> <span>Manage Category Record</span> <i class="#"></i></a></li>
			<li>	<a href="managepolicyap.php"><i class="fa fa-file-text"></i> <span> Manage Policy Records</span></a></li>
					<li>	<a href="managefilead.php"><i class="fa fa-file-text"></i> <span> File Manager</span></a></li>
							                                          <li><a href="../Customers/adminpolicy.php"><i class="fa fa fa-search"></i> <span>View Policy</span></a></li>
              ...
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="post" action="addcategoryAP.php">
                   <fieldset>
                        ...
                        <input class="form-control" placeholder="Department" value="Administrative Policy" name="department" type="text" required>
