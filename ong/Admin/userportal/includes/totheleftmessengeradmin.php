                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li >  <a href="dashboard.php" style="font-size:17px; background-color:brown;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Main Dashboard</emp></span> </a>
									  
									  
									  		       <li>  <a href="home.php" style="font-size:17px;"><i class="fa fa-bullhorn"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Newsfeed</emp></span> </a>
									  
									      <li class="active">  <a href="Messenger.php" style="font-size:17px;"><i class="fa fa-list"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Messenger Dashboard</emp></span> </a>
		...
		<li class="actsve">  <a href="message.php" style="font-size:17px;"><i class="fa fa-envelope-o"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Read Message</emp></span> </a>				 
		 ...
		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									       ...
									       <li>  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Public Groupchat</emp></span> </a>
									        ...
									        <li>  <a href="Staffdbdashboard.php" style="font-size:17px;"><i class="fa fa-database"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;MIS Msgr Reports</emp></span> </a>
											        
													<li>  <a href="jrfmftgdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-equalizer"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Manufacturing Reports</emp></span> </a>
													
														<li>  <a href="Staffdbdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-copy"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;GS Msgr Reports</emp></span> </a>
														
													
									  
									  <li>  <a href="Staffdbdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-certificate"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Logistic Msgr Reports</emp></span> </a>
									  
									  
									  
									  <li>  <a href="Staffdbdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-ban-circle"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;Finance Msgr Reports</emp></span> </a>
									  
									  
									  
									  
									  <li>  <a href="Staffdbdashboard.php" style="font-size:17px;"><i class="glyphicon glyphicon-gift"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;HR Msgr Reports</emp></span> </a>
