...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li>  <a href="../userdashboard.php" style="font-size:17px;background-color:brown;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Main Dashboard</emp></span> </a>
									        ...
									        <li class="actaive">  <a href="Messenger.php" style="font-size:17px;"><i class="fa fa-list"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Messenger Dashboard</emp></span> </a>
		...
		<li class="actsve">  <a href="message.php" style="font-size:17px;"><i class="fa fa-envelope-o"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Read Message</emp></span> </a>				 
		 ...
		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
		      ...
		      <li class="active">  <a href="Staffdbdashboard.php" style="font-size:17px;"><i class="fa fa-database"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Staff Database Reports</emp></span> </a>
