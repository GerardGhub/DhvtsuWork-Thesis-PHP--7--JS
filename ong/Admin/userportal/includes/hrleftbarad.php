                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="nav-header">
                                        <span class="">Appearance</span>
									       ...
									       <li><a href="managehr.php"><i class="glyphicon glyphicon-stats"></i> <span style="font-size:17px;">&nbsp;&nbsp;HRD Monitoring</</span></a></li-->
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
										   ...
										   <a data-toggle="modal" data-target="#uploadModalcategorymis"><i class="fa fa-star"></i> <span>Add New Subject </span> <i class="#"></i></a>
										      <a data-toggle="modal" data-target="#uploadModalsamplex"><i class="fa fa-star"></i> <span>Add New HR Policy</span> <i class="#"></i></a>
   ...
   <li class="has-children">
     ...
     <li>
									  ...
									  <!--li><a href="dito/librarian/add_books.php"><i class="fa fa fa-server"></i> <span> Add MIS</span></a></li-->
                                        ...
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Select HRD Policy </span> <i class="fa fa-angle-right arrow"></i></a>
										
                                        <ul class="child-nav">
										  <li> <a href="managecathr.php"><i class="fa fa-file-text"></i> <span>Manage Subject </span> <i class="#"></i></a>
			<!--li><a href="managepolicyhr.php"><i class="fa fa-file-text"></i> <span> Manage Policy</span></a></li-->
			
		<li><a href="viewhrpolicy.php"><i class="fa fa-file-text"></i> <span> Policy Monitoring</span></a></li>
			
			
			<li><a href="managesectionhr.php"><i class="fa fa-file-text"></i> <span> Manage Dep_Section</span></a></li>
						                                          <li><a href="../Customers/hrdad.php"><i class="fa fa fa-search"></i> <span>View HR Policy</span></a></li>
									 ...
									 <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="manageuserhr.php"><i class="fa fa fa-server"></i> <span>Manage User Records</span></a></li>
									...
									<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                           ...
                                           <li><a href="managememogs.php"><i class="fa fa fa-server"></i> <span>Manage Memorandum</span></a></li>
										                                          <li><a href="../Customers/memorandumhr.php"><i class="fa fa fa-search"></i> <span>View Memorandum</span></a></li>
                                        </ul>
                                    </li>
...
<!-- Mediul Modal -->
	...
	<option value="<?php echo $cat_row['category_id']; ?>"><?php echo $cat_row['classname']; ?></option>
			<?php  } ?>
                        ...
                        <input id="priceinput" class="form-control" value="HR Department" name="department" readonly="readonly" type="text"required>
                            ...
                            <div class="form-group">
                                ...
                                <input id="priceinput" class="form-control" value="<?php echo $_SESSION['sess_user_image'];?>" name="uploadbyimg" type="text">
        ...
        <div class="modal fade" id="uploadModalcategorymis" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h2 style="color:white" class="modal-title" id="myModalLabel"><center>Add New HR Subject Title</center></h2>
              </div>
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="post" action="addcategoryhr.php">
                   <fieldset>
						   ...
						   <?php
						   include('dbcon.php');
			$cat_query = mysql_query("SELECT * FROM hrddepfinal");
			while($cat_row = mysql_fetch_array($cat_query)){
			?>
	<option value="<?php echo $cat_row['category_id']; ?>"><?php echo $cat_row['classname']; ?></option>
			<?php  } ?>
          ...
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              ...
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="post" action="adddepartmentsectionhr.php">
                   <fieldset>
