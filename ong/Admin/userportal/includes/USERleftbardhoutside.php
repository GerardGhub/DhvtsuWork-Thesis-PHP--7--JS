...
<div class="left-sidebar bg-black-300 box-shadow ">
       ...
       <li><a href="#Customers/memorandum.php" style="font-size:17px;"><i class="fa fa-users"></i> <span>&nbsp;&nbsp;Offices Shared Forms</span> <i class="fa fa-angle-righst arrowd"></i></a></li>       	   
       ...
       <!--li><a href="../admin/misdashboardfinaljob.php" style="font-size:17px;"><i class="fa fa-info"></i> <span>&nbsp;&nbsp;MIS</span> <i class="#"></i></a></li-->
			   ...
			   <li><a href="Manager/onggallery.php" style="font-size:17px;"><i class="glyphicon glyphicon-picture"></i> <span>&nbsp;&nbsp;&nbsp;Manpower Gallery</span> <i class="#"></i></a></li>
       ...
       <li><a href="Manager/Messenger.php" style="font-size:17px;"><i class="glyphicon glyphicon-envelope" ></i> <span>&nbsp;&nbsp;Face OG Messenger</span> <i class="#"></i></a></li>
