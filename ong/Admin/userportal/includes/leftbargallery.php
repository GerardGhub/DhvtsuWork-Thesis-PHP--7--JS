...
<div class="left-sidebar bg-black-300 box-shadow ">
               ...
               <li style="color:black"><a href="adminmanageappolicy.php"><!--o class="glyphicon glyphicon-star"></o--><b style="font-size:17px;">Administrative Policy</b></a></li>
                  ...
                  <li class="dropdown-submenu" style="color:black">
                    <a href="#"><!--i class="glyphicon glyphicon-queen"></i--><b style="font-size:17px;">Quality Control</b></a>
                    <!--ul class="dropdown-menu">
                        <li><a href="#"><i class="glyphicon glyphicon-transfer"></i>Warehouse</a></li>
                    	<li><a href="#"><i class="glyphicon glyphicon-sort"></i>Impex</a></li>
                    </ul-->
					  ...
					  <li class="dropdown-submenu" style="color:black">
					    <a href="#"><!--i class="glyphicon glyphicon-scissors"></i--> <b style="font-size:17px;">Pattern</b></a>
                    <!--ul class="dropdown-menu">
                        <li><a href="#"><i class="glyphicon glyphicon-usd"></i>Accounting</a></li>
                    	<li><a href="#"><i class="glyphicon glyphicon-piggy-bank"></i>Purchasing</a></li>
                    </ul-->
                  </li>
               <li style="color:black"><a href="#"><!--o class="glyphicon glyphicon-yen"></o--><b style="font-size:17px;">Product & Pricing</b></a></li>
                  <li style="color:black"><a href="#"><!--i class="glyphicon glyphicon-hourglass"></i--><b style="font-size:17px;">Planning & Production </b></a></li>
				  <li style="color:black"><a href="#"><!--i class="glyphicon glyphicon-equalizer"></i--><b style="font-size:17px;">Order & Material</b></a></li>
                </ul>
              </li>
...
<li>
                                      ...
                                      <li><a href="orgchart.php" style="font-size:17px;"><i class="glyphicon glyphicon-th-list">&nbsp;</i> <span>Organizational Chart </span> <o class="fa fa-angle-right arrow"></o></a></li>
                                      ...
                                      <li><a href="../Customers/gallerycount.php" style="font-size:17px;"><i class="glyphicon glyphicon-picture">&nbsp;</i> <span>My Photos </span> <!--o class="fa fa-angle-right arrow"></o--></a></li>
										
                  
									 
									   <li>  <a href="videoplayer.php" style="font-size:17px;"><i class="glyphicon glyphicon-facetime-video"></i> <span>&nbsp;&nbsp;
					  Videos Player</span>
                                    </li>
									

									<li>
									  <a data-toggle="modal" data-target="#uploadModalcategorymisgallery" style="font-size:17px;"><i class="fa fa-plus"></i> <span>New Photos Category </span> <i class="#"></i></a>
									  
									  </li>

	<li>
									  <a data-toggle="modal" data-target="#uploadModalsamplexgallery" style="font-size:17px;"><i class="fa fa-plus"></i> <span>New Photos Upload </span> <i class="#"></i></a>
				   ...
				   <a href="../Customers/sampleyakanu.php"><i class="glyphicon glyphicon-briefcase"></i> <span>&nbsp;O&G Policy Downloads</span> <i class="#"></i></a>
        ...
        <div class="modal fade" id="uploadModalcategorymisgallery" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <center><h2 style="color:white" class="modal-title" id="myModalLabel">Add New Photo Category Title</h2></center>
              </div>
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="post" action="addcatmisgallery.php">
                   <fieldset>
					
						
                            <p>Category Photo Events</p>
                            <div class="form-group">
							
                                <input class="form-control" placeholder="" name="classname" type="text" required>
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-success btn-md" name="item_save">Save</button>
				 ...
				 <button type="button" class="btn btn-danger btn-md" data-dismiss="modal">Cancel</button>
						...
						<!-- Mediul Modal -->
        <div class="modal fade" id="uploadModalsamplexgallery" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               <center > <h2 style="color:white" class="modal-title" id="myModalLabel">Add New Photos !!!!</h2></center>
              </div>
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="post" action="addgallery.php">
                   <fieldset>
                        ...
                        <input id="priceinput" class="form-control" value="MIS" name="department" readonly="readonly" type="text"required>
						   ...
						   <?php
						   include('dbcon.php');
			$cat_query = mysql_query("SELECT * FROM gallerycategory");
			while($cat_row = mysql_fetch_array($cat_query)){
			?>
	<option value="<?php echo $cat_row['category_id']; ?>"><?php echo $cat_row['classname']; ?></option>
			<?php  } ?>
