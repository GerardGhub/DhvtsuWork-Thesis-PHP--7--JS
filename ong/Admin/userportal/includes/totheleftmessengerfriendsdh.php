...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li>  <a href="../userdashboard.php" style="font-size:17px; background-color:maroon;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Main Dashboard</emp></span> </a>
									   ...
									   <li class="actsive">  <a href="Messenger.php" style="font-size:17px;"><i class="fa fa-list"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Messenger Dashboard</emp></span> </a>
		 ...
		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Personal Photos</emp></span> </a>								
									  
									       <li>  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Public Messenger</emp></span> </a>
