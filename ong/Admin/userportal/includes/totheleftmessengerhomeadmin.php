...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li>  <a href="dashboard.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Dashboard</emp></span> </a>
									  		       ...
									  		       <li class="active">  <a href="home.php" style="font-size:17px;"><i class="fa fa-bullhorn"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Newsfeed</emp></span> </a>
    ...
    <li class="activde">  <a href="Messenger.php" style="font-size:17px;"><i class="fa fa-list"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Messenger Dashboard</emp></span> </a>
		 ...
		 <li>  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									  ...
									  <li class="actisve">  <a href="opmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-plane"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;OP Msgr Reports</emp></span> </a>
