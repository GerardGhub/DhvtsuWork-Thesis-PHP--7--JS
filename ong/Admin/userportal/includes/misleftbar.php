...
<div class="left-sidebar bg-black-300 box-shadow ">
   ...
   <li class="has-children">
     ...
     <li>
   <a href="managecatmis.php"><i class="fa fa-file-text"></i> <span>Manage Category Records</span> <i class="#"></i></a>
</li>                                      
									
                                        <li>
										<a href="managepolicy.php"><i class="fa fa-file-text"></i> <span> Manage Policy Records</span></a></li>
 ...
 <a href="adminpolicymanage.php"><i class="fa fa-newspaper-o"></i> <span>Manage O&G Policy Count</ </span></a></li>
									 ...
									 <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <!--li><a href="add-students.php"><i class="fa fa-bars"></i> <span>Add Users</span></a></li-->
                                            <li><a href="manageuser.php"><i class="fa fa fa-server"></i> <span>Manage User Records</span></a></li>
									...
									<li class="has-children">
<?php echo $item_image; ?>
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>O$G Memorandum</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <!--ul class="child-nav">
