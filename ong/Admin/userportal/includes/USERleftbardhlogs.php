...
<div class="left-sidebar bg-black-300 box-shadow ">
					...
					<p style="text-align:center;"><img class="img-circle" src="item_images/<?php echo $_SESSION['sess_user_image'];?>" height="100" width="180" /></p>
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
                                      <li class="active">  <a href="../userdashboard.php" style="font-size:17px; background-color:brown;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Main Dashboard</span> </a></li>
				     ...
				     <li class="active"><a href="activeuserlogs.php" style="font-size:17px;"><i class="glyphicon glyphicon-user" ></i> <span>&nbsp;&nbsp;User Department Logs</span> <i class="#"></i></a></li>
