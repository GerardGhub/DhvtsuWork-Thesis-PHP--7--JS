...
<div class="left-sidebar bg-black-300 box-shadow ">
					   ...
					   <li class="has-children">
									  ...
									  <li><a href="../Customers/userdatainfo.php"><i class="fa fa fa-server"></i> <span>View User Profile</span></a></li>
                                       ...
                                       <!--a href="#"><o class="glyphicon glyphicon-cloud">&nbsp;</o> <span>MIS Policy </span> <o class="fa fa-angle-right arrow"></o></a-->
				   ...
				   <a data-toggle="modal" data-target="#uploadModalcategorymis"><i class="fa fa-plus-circle"></i> <span>Add New Category </span> <i class="#"></i></a>
					 ...
					 <li><a href="managecatmis.php"><i class="fa fa-file-text"></i> <span>Manage Category</</span></a></li>
				    <li><a href="managepolicy.php"><i class="fa fa-file-text"></i> <span>Manage Policy</</span></a></li>
									...
									<li class="has-children">
                                        <!--a href="#"><i class="glyphicon glyphicon-duplicate"></i> <span>&nbsp; Memorandum</span> <i class="fa fa-angle-right arrow"></i></a-->
                                        <ul class="child-nav">
                                            <!--li><a href="add-students.php"><i class="fa fa-bars"></i> <span>Add Users</span></a></li-->
                                           ...
                                           <li><a href="managememogs.php"><i class="fa fa fa-server"></i> <span>Manage Memorandum</span></a></li>
										   								                                          <li><a href="../Customers/sg3.php"><i class="fa fa fa-search"></i> <span>View Memorandum</span></a></li>
