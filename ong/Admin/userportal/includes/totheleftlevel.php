                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-sizer:20px;">
                                      <li style="background-color:browsn;">  <a href="managefinance.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span>&nbsp;&nbsp;Dashboard</span> </a></li>
									  
									  
									  
									  <li class="active">
				    <a rel="tooltip" class="btn btn-danger" style="border-color:#008CBA;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" a href="updates.php"   class="btn btn-light"><span class="
glyphicon glyphicon-stats" style="text-align:center; color:white; font-size:17px;"></span><i class="icon-trash icon-large"></i><span style="color:white;">Stock Level Monitoring Dashboard</span></a></li>
									  ...
									  <li>
									    <a rel="tooltip" class="btn btn-info" style="border-color:#008CBA;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" a data-toggle="modal" data-target="#uploadModalsamplexmemosuperjeje" data-toggle="modal"    class="btn btn-light"><span class="
glyphicon glyphicon-cloud-upload" style="text-align:center; color:grey; font-size:17px;"></span><i class="icon-trash icon-large"></i><span style="color:black;">&nbsp;Upload New Stock Level</span></a></li>


	  <li>
									    <a rel="tooltip" class="btn btn-info" style="border-color:#008CBA;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" a data-toggle="modal" data-target="#uploadModalsamplexmemosuperjeje" data-toggle="modal"    class="btn btn-light"><span class="
glyphicon glyphicon-tags" style="text-align:center; color:grey; font-size:17px;"></span><i class="icon-trash icon-large"></i><span style="color:black;">&nbsp;Upload New Unit of Measure</span></a></li>
	...
	<li>
				    <a rel="tooltip" class="btn btn-info" style="border-color:#008CBA;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" a data-toggle="modal" data-target="#uploadModalsamplexmemosuperjeje" data-toggle="modal"    class="btn btn-light"><span class="
glyphicon glyphicon-calendar" style="text-align:center; color:grey; font-size:17px;"></span><i class="icon-trash icon-large"></i><span style="color:black;">&nbsp;Upload New Date & Year</span></a></li>
	...
	<li>
				    <a rel="tooltip" class="btn btn-primary" style="border-color:#008CBA;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" a data-toggle="modal" data-target="#uploadModalsamplexmemosuperjeje" data-toggle="modal"    class="btn btn-light"><span class="
glyphicon glyphicon-user" style="text-align:center; color:white; font-size:17px;"></span><i class="icon-trash icon-large"></i><span style="color:white;">&nbsp;User Stock Level Repots</span></a></li>

</li>

	<li>
				    <a rel="tooltip" class="btn btn-primary" style="border-color:#008CBA;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" a href="monthlycheck.php" class="btn btn-light"><span class="
glyphicon glyphicon-calendar" style="text-align:center; color:white; font-size:17px;"></span><i class="icon-trash icon-large"></i><span style="color:white;">&nbsp;Manage Date & Year</span></a></li>

</li>


<li>
				    <a rel="tooltip" class="btn btn-primary" style="border-color:#008CBA;" title="Click to Upload files"  stytle="text-align:center;" id="<?php echo $id; ?>" a href="viewmonthlycheck.php" class="btn btn-light"><span class="
glyphicon glyphicon-shopping-cart" style="text-align:center; color:white; font-size:17px;"></span><i class="icon-trash icon-large"></i><span style="color:white;">&nbsp;Stock Level Monitoring</span></a></li>
        ...
        <div class="modal fade" id="uploadModalsamplexmemosuperjeje" tabindex="-1" width="250" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
       <h2 style="color:white;" class="modal-title" id="myModalLabel"><center class="#fa fa-servera" style="text-align:center;">Add&nbsp;New&nbsp;Stock Level</center>
              </div>
              <!--div class="modal-body"-->
...
$query=$conn->query("INSERT INTO stocklevel (particulars,uom,New_approve,Allocation,For_purchase) VALUES ('$particulars','$date','$upload_by','$department')");
if($query){
	
 echo "<script>window.open('monitorings.php','_self')</script>";
...
#photo
{
   ...
   font-size: 20px;
	...
	<!--div class="alert alert-info">
			...
			<tr>
			<td style="display:none;"><form enctype="multipart/form-data" action="" id="wb_Form1" name="form" method="post">
				
					<input type="file" name="photo" style="width:550px;" id="photo">
				...
				<input type="text" name="upload_by" class="form-control" value="<?php echo $_SESSION['sess_department'];?>" readonly>
					
					</td>
					
							<input type="text" name="upload_by" class="form-control" placeholder="Particulars">
					</td>
					
								</td>
					
							<input type="text" name="upload_by" class="form-control" placeholder="UOM">
					</td>
					
					
								</td>
					
							<input type="text" name="upload_by" class="form-control" placeholder="New Approved Stock Level">
					</td>
							...
							<input type="text" name="upload_by" class="form-control" placeholder="Ending Inventory on Hand">
					</td>
					
										</td>
					
							<input type="text" name="upload_by" class="form-control" placeholder="Allocation for the month">
					</td>
					
												</td>
					
							<input type="text" name="upload_by" class="form-control" placeholder="For Purchase">
					</td>
