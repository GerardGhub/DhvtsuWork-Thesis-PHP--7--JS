                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:17px; background-color:brown; border-radius:20px;">
                                    ...
                                    <li class="has-children">
									    ...
									    <li><a href="managemyport.php"><i class="glyphicon glyphicon-stats"></i> <span style="font-size:17px;">&nbsp;&nbsp;PortFolio Monitoring</</span></a></li>
   ...
   <li class="has-children">
     ...
     <li>
					  ...
					  <li> <a href="managecatgs.php"><i class="fa fa-file-text"></i> <span>Manage Subject</span> <i class="#"></i></a></li>
					    ...
					    <li> <a href="postedlist.php"><i class="fa fa-file-text"></i> <span>Posted Worklist</span> <i class="#"></i></a></li>
					  
					  
					
					  <li> <a href="worklist.php"><i class="fa fa-file-text"></i> <span>Manage Worklist</span> <i class="#"></i></a></li>					
        ...
        <div class="modal fade" id="uploadModalsamplex" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
     <center> <h2 style="color:white" class="modal-title" id="myModalLabel">Add New Photos in PortFolio</h2></center>
              </div>
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="post" action="addportfolio.php">
                   <fieldset>
						   ...
						   <?php
						   include('dbcon.php');
			$cat_query = mysql_query("SELECT * FROM project");
			while($cat_row = mysql_fetch_array($cat_query)){
			?>
	<option value="<?php echo $cat_row['item_id']; ?>"><?php echo $cat_row['Jobtitle']; ?></option>
			<?php  } ?>
