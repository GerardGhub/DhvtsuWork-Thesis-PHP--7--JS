...
<div class="left-sidebar bg-black-300 box-shadow ">
				...
				<li class="actsve">  <a href="sentmessage.php" style="font-size:17px;"><i class="fa fa-send"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Sent Items</emp></span> </a>						
						...
						<li class="actsve">  <a href="#sentmessage.php" style="font-size:17px;"><i class="fa fa-warning"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Message Reported</emp></span> </a>		
		 ...
		 <li class="actsive">  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									       ...
									       <li class="activde">  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Groupchat Messenger</emp></span> </a>
									  
			                                       		


      <li class="active">  <a href="Groupmessengerdep.php" style="font-size:17px;"><i class="fa fa-user"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Department Groupchat</emp></span> </a>													
