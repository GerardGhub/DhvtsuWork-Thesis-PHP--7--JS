...
<div class="left-sidebar bg-black-300 box-shadow ">
                    ...
                    <li class="actisve"><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemojrf" style="font-size:17px;"><i class="	fa fa-paper-plane-o">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Data Statistic Graph </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
					
					
							 <li class="active"><a href="storage.php" style="font-size:17px;"><i class="	fa fa-star">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Storage Monitoring </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>			
