...
<div class="left-sidebar bg-black-300 box-shadow ">
		 ...
		 <!--li><a data-toggle="modal"  title="Notifications" data-target="#Uploadmemojrf" style="font-size:17px;"><i class="fa fa-plus" style="color:white;">&nbsp;</i> <span>Request kang JRF </span> 
						 ...
						 <li class="#active"><a href="JRFREQUESTactivity.php" style="font-size:17px;"><i class="fa fa-pencil">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>MIS Activity Logs </span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
						  						 
											 
						 <li class="#active"><a href="JRFREQUEST.php" style="font-size:17px;"><i class="fa fa-shopping-cart">&nbsp;&nbsp;&nbsp;</i>&nbsp;&nbsp; <span>Job Request History</span> <!--o class="#fa fa-angle-right arrow"></o--></a></li>
