...
<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li style="font-size:20px;">
                                      <li>  <a href="dashboard.php" style="font-size:17px;"><i class="fa fa-dashboard"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Dashboard</emp></span> </a>
									  		       ...
									  		       <li class="actsive">  <a href="home.php" style="font-size:17px;"><i class="fa fa-bullhorn"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Newsfeed</emp></span> </a>
									  
									    <li class="activde">  <a href="Messenger.php" style="font-size:17px;"><i class="fa fa-list"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Messenger Dashboard</emp></span> </a>
									  
									  
				 <li class="actisve">  <a href="friends.php" style="font-size:17px;"><i class="fa fa-child fa fa-wifi"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Contact Lists</emp></span> </a>	

					  
				 <li>  <a href="message.php" style="font-size:17px;"><i class="fa fa-comments-o"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Message</emp></span> </a>	
				 
									  
							<li class="actsve">  <a href="readmessage.php" style="font-size:17px;"><i class="fa fa-envelope-o"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Read Message</emp></span> </a>				 
									  
							
				<li class="actsve">  <a href="sentmessage.php" style="font-size:17px;"><i class="fa fa-send"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Sent Items</emp></span> </a>						
		 ...
		 <li class="actsive">  <a href="photos.php" style="font-size:17px;"><i class="fa fa-image"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Photos</emp></span> </a>								
									  
									       <li class="active">  <a href="Groupmessenger.php" style="font-size:17px;"><i class="fa fa-users"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Groupchat Messenger</emp></span> </a>
									  
			                                       		


      <li class="activse">  <a href="Groupmessengerdep.php" style="font-size:17px;"><i class="fa fa-user"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;Department Groupchat</emp></span> </a>														
 ...
 <li class="actiave">  <a href="staffdbdashboard.php" style="font-size:17px;"><i class="fa fa-database"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;MIS Msgr Reports</emp></span> </a>
									  ...
									  <li class="act2ive">  <a href="opmsgrreports.php" style="font-size:17px;"><i class="glyphicon glyphicon-plane"></i> <span style="color:whitess;"><emp>&nbsp;&nbsp;&nbsp;OP Msgr Reports</emp></span> </a>
...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
  ...
  <div class="form-group" style="background-image: url("..\item_images\amazing.gif");">
   <center><img src="..\item_images\<?php echo $_SESSION['sess_user_image'];?>" width="175" height="175"></center><center><emp class="btn btn-dangers" style="font-size:24px;color:whitesmoke; padding-top:5px;width:210px;height:34px;text-align:center;"> <?php echo $_SESSION['sess_fname'];?> &nbsp;<?php echo $_SESSION['sess_lastname'];?>  </emp></center>
