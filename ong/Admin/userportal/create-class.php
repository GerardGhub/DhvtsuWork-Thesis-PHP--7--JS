...
<html lang="en">
    <head>
        ...
        <title>SMS Admin Create Department</title>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Department Ofiicer</label>
                                                		<div class="">
                                                			<input type="text" name="classname" class="form-control" required="required" id="success">
                                                            <span class="help-block">Eg- Manager, OIC, etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- Mis,Finance,HRs etc</span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
