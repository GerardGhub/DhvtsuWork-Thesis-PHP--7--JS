...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM administrativepolicy WHERE item_id=:item_id');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE administrativepolicy
			...
			if($stmt->execute()){
				...
				window.location.href='managepolicyap.php';
				</script>
                <?php
			}
			else{
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="fa fa-users" style="font-size:23px;">Administrative Policy</h4>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="adminmanageappolicy.php"><i class="fa fa-home"></i> Home</a></li>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td>
        	<p><img class="img img-thumbnail" src="../item_images/<?php echo $item_image; ?>" height="330" width="330" /></p>
    ...
    <tr>
        ...
        <a class="btn btn-danger" href="managepolicyap.php"> <span class="glyphicon glyphicon-backward"></span> Cancel </a>
