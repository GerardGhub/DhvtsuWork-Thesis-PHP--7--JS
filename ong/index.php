...
<head>
    ...
    <title>O&G Leather Mftg Corp</title>
	 <link rel="shortcut icon" href="Admin/item_images/GerardSs.jpg" type="image/x-icon" />
...
<!-- tib ton -->
		  <script src="Admin/jsonepiece/bootstrap.min.js"></script>

	    <script src="Admin/jsonepiece/jquery-1.12.4.js"></script>

    
	<script type="text/javascript" src="Admin/jquery.fancybox.js?v=2.1.5"></script>

	<link rel="stylesheet" type="text/css" href="Admin/jquery.fancybox-buttons.css?v=1.0.5" />
	<script type="text/javascript" src="Admin/jquery.fancybox-buttons.js?v=1.0.5"></script>
	<link rel="stylesheet" type="text/css" href="Admin/jquery.fancybox-thumbs.css?v=1.0.7" />
	<script type="text/javascript" src="Admin/jquery.fancybox-thumbs.js?v=1.0.7"></script>
	<script type="text/javascript" src="Admin/jquery.fancybox-media.js?v=1.0.6"></script>
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<li> <a href="#section3"> <emp class="fa fa-briefcase"> </emp>&nbsp; SCHEDULE</a></li>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="Admin/item_images/img1.jpg" alt="Hero Slide" style="width:100%;height:830px;">
        ...
        <div class="item">
            <img src="Admin/item_images/img2.jpg" alt="..." style="width:100%;height:830px;">
        ...
        <div class="item">
            <img src="Admin/item_images/img3.jpg" alt="..." style="width:100%;height:830px;">
		...
		<div class="item">
            <img src="Admin/item_images/img4.jpg" alt="..." style="width:100%;height:830px;">
		...
		<div class="item">
            <img src="Admin/item_images/img5.jpg" alt="..." style="width:100%;height:830px;">
		...
		<div class="item">
            <img src="Admin/item_images/img6.jpg" alt="..." style="width:100%;height:830px;">
...
<img class="icon" src="Admin/item_images/rocket.svg" alt="Icon">
<h3>MISSION</h3>
<p> Be unique in delivering<br> Creativeness</p>
</section>

<section class="col-md-4">
<img class="icon" src="Admin/item_images/earth.png" alt="Icon">
<h3>VISION</h3>
...
<section class="col-md-4">
<img class="icon" src="Admin/item_images/cap.png" alt="Icon">
<h3>VISION</h3>
...
<p style="font-style: arial; font-size:17px;">O&G is a manufacturing company of leather goods with headquarter in Unit 4A Philexcel Business Park, Clark Freeport Zone, Philippines. O&G was organized in December 2004 with the purpose to combine Italian creativity with the Filipinos craftsmanship.</p>
				...
				<section class="col-md-6">
<img class="iconsx" src="Admin/item_images/company1.svg" alt="Icon" width="240">
		...
		<div class="row">	
				...
				<br>
							...
							<section class="col-md-6">
<img class="iconsx" src="Admin/item_images/creativity.png" alt="Icon" width="240">
...
<p style="font-size:17px;">It’s not all about work. O&G offers competitive compensation and benefits to support you both personally and professionally.</p>
							...
							<section class="col-md-6">
<img class="iconsx" src="Admin/item_images/idea.svg" alt="Icon" width="240">
...
<emp class="mapouter"><div class="gmap_canvas"><iframe width="1495" height="575" id="gmap_canvas" src="https://maps.google.com/maps?q=o%26G%20leather%20&t=k&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.crocothemes.net"></a></div>
</section>
