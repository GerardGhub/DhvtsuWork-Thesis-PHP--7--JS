...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../ong/Admin/userportal/css/font-awesome.min.css" media="screen" >
        <link rel="stylesheet" href="../ong/Admin/userportal/css/animate-css/animate.min.css" media="screen" >
        <link rel="stylesheet" href="../ong/Admin/userportal/css/lobipanel/lobipanel.min.css" media="screen" >
        <link rel="stylesheet" href="../ong/Admin/userportal/css/toastr/toastr.min.css" media="screen" >
        <link rel="stylesheet" href="../ong/Admin/userportal/css/icheck/skins/line/blue.css" >
        <link rel="stylesheet" href="../ong/Admin/userportal/css/icheck/skins/line/red.css" >
        <link rel="stylesheet" href="../ong/Admin/userportal/css/icheck/skins/line/green.css" >
        <link rel="stylesheet" href="../ong/Admin/userportal/css/main.css" media="screen" >
		        <link rel="stylesheet" href="../animate.css" media="screen" >
		     <link rel="stylesheet" href="leftbar.css" media="screen" >
        <script src="../../ong/Admin/userportal/js/modernizr/modernizr.min.js"></script>
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
        ...
        <link rel="stylesheet" type="text/css" href="../../ong/Admin/userportal/js/DataTables/datatables.min.css"/>
    ...
    <body class="top-navbar-fixed">
            ...
            <div class="content-wrapper">
                <div class="content-container">
						...
						<?php include('../ong/Admin/userportal/includes/dbcon.php');?>
...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
	  $('#example').dataTable();
        ...
        <script src="../ong/Admin/userportal/js/jquery/jquery-2.2.4.min.js"></script>
        <script src="../ong/Admin/userportal/js/bootstrap/bootstrap.min.js"></script>
        <script src="../ong/Admin/userportal/js/pace/pace.min.js"></script>
        <script src="../ong/Admin/userportal/js/lobipanel/lobipanel.min.js"></script>
        <script src="../ong/Admin/userportal/js/iscroll/iscroll.js"></script>
        <script src="../ong/Admin/userportal/js/prism/prism.js"></script>
        <script src="../ong/Admin/userportal/js/DataTables/datatables.min.js"></script>
        <script src="../ong/Admin/userportal/js/main.js"></script>
        <script>
            $(function($) {
                $('#example').DataTable();
