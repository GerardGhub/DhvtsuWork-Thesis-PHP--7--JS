...
?>                        
            				<div class="">
                                ...
                                <a href="#" onClick="showFriends('<?php echo $my_type; ?>','Admin','<?php echo $my_index; ?>')" class="btn btn-md bg-green-active"  data-id=""><i class="fa fa-user-plus" aria-hidden="true">Principal</i></a>
                            </div>
