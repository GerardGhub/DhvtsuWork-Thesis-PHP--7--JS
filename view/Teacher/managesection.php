...
<!-- table for view all records -->
	...
	<thead>
              ...
              <tbody>
			  <?php
include("../Dashboard_Principal/config.php");
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<center> <img src="../item_images/saelogo.jpg" class="img img-rounded"  width="50" height="50" /></center>
				 ...
				 <a class="btn btn-info" href="editsection.php?edit_id=<?php echo $row['category_id']; ?>" title="Click for Edit" onclick="return confirm('Are you sure edit this Section?')"><span class='glyphicon glyphicon-pencil'></span> Edit</a> 
				
                  <a class="btn btn-danger" href="?delete_id=<?php echo $row['category_id']; ?>" title="Click for Delete" onclick="return confirm('Are you sure to remove this Section?')"><span class='glyphicon glyphicon-trash'></span> Delete</a>
