...
<!-- tib ton -->
		  <script src="../Dashboard_Principal/jsmodule/jsonepiece/bootstrap.min.js"></script>

	    <script src="../Dashboard_Principal/jsmodule/jsonepiece/jquery-1.12.4.js"></script>
                            ...
                            <div class='modal-dialog modal-lg'>
                                ...
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-footer'>
										...
										<a data-toggle='modal' data-target='#uploadModalsamplexmemosuperjeje' data-toggle='modal'class='btn btn-primary'>Send Request</a>
...
$query=$conn->query("INSERT INTO postingsender (item_image,item_date,upload_by,department,Jobtitle,fname,mname,lname,Contact,Email,requestor_id) VALUES ('$name','$date','$upload_by','SAE','$Jobtitle','$fname','$mname','$lname','$Contact','$Email','$index')");
if($query){
