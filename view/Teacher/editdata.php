...
require_once '../Dashboard_Principal/config.php';

if(isset($_GET['edit_id']) && !empty($_GET['edit_id']))
{
	$id = $_GET['edit_id'];
	$stmt_edit = $DB_con->prepare('SELECT * FROM mis WHERE category_id=:category_id');
...
?>
    ...
    <tr>
	 ...
	 <tr>
        ...
        <td><input id="inputprice" class="form-control" type="date" name="issuedate" value="<?php echo $issuedate; ?>" required /></td>
    </tr>
		 <tr>
