	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
            ...
            ?></td>
				 ...
				 <a class="btn btn-info" href="editcategory.php?edit_id=<?php echo $row['category_id']; ?>" title="Click for Edit" onclick="return confirm('Are you sure edit this Module?')"><span class='glyphicon glyphicon-pencil'></span> Edit</a> 
				
                  <a class="btn btn-danger" href="?delete_id=<?php echo $row['category_id']; ?>" title="Click for Delete" onclick="return confirm('Are you sure to remove this Module?')"><span class='glyphicon glyphicon-trash'></span> Delete</a>
