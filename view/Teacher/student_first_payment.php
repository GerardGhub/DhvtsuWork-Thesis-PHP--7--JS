            			...
            			<div class="panel-body"><!--panel-body -->
                        	<div class="row " id="msk12345">
                                ...
                                <div class="col-xs-5 class-name">
                                	<h2>San Antonio Elementary School</h2>
                                	<div class="class-address">
                                    	Mexico<br>
									    ,Pampanga 2021
                                    </div>
                                </div>
                                <div class="col-xs-4 class-email text-right " style="background-color:white; color:black;">
                                    	Email: sae@gmail.com<br>
                                        Phone: +639-055-666-111 <br> 
                                </div>
                        	</div>
                            <div class="row ">
                                <div class="col-xs-5">
