...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Module Monitoring</a></li>
    	</ol>
	</section>
...
<!-- table for view all records -->
	...
	<thead>
              ...
              <th style="width:2%;background-color:#454545; color:white;">Logo</th>
               					     <th style="width:11%;background-color:#454545; color:white;">Grade</th>
      ...
      <tr>
	     <td class="zoom">
            ...
            // $cat=$row['item_id'];
            // $query1 = mysql_query("select * from std_db.filemgrfinance where grade='$id'") or die(mysql_error());
...
$connection=mysqli_connect('localhost','root','','std_db');
          ...
          $cate=$row['id'];
                    ...
                    $count_query = mysqli_query($connection,"select * from std_db.filemgrfinance where grade='$cate'") or die(mysqli_error());        
        ...
        <td width="140" style="text-align:center; width:15%;">
                <a  rel="tooltip"  title="View" id="v<?php echo $id; ?>"  href="listofmodule.php?id=<?php echo $row['id'];?>" class="btn btn-primary button button4">View Documents &nbsp;<i class="icon-list icon-large"></i></a>
           </td>
      </tr>
      <?php } ?>
                                </tbody>
