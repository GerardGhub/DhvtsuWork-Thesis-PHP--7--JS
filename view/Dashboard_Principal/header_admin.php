...
<div class="wrapper" >
  <header class="main-header"  >
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><strong>SAE</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="color:white;"><strong>San Antonio Elementary School</strong></span>
    </a>
...
?> 
            	...
            	<li class="dropdown user user-menu" >
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <span class="hidden-xs " style="color:white"><?php echo $row['i_name']; ?></span>
                    </a>
                    <ul class="dropdown-menu" style="background-color:#00a7d0;">
                      <!-- User image -->
                      ...
                      <!-- Menu Footer-->
                      <li class="user-footer " style="background-color:#00a7d0;">
                        <div class="pull-left">
                          <a href="admin_profile.php" class="btn btn-primary">Profile</a>
                        </div>
