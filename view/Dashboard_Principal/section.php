  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="exampleModalLabel">Append Section
						...
						<div class="box-body">
                			<div class="form-group" id="divName">
                    			<label for="">Section</label>
                      			<input type="text" class="form-control" id="name" placeholder="Section" name="name" autocomplete="off">                    
                    		</div>
                    
                		</div><!-- /.box-body -->
                		<div class="box-footer">
                  			<input type="hidden" name="do" value="add_section" />
...
//MSK-00104
    ...
    xhttp.open("GET", "../../model/get_section.php?id=" + Id , true);												
...
//MSK-000126
	...
	var table_name= "section";//give data table name
