  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="exampleModalLabel">Append Subject</h5>
	...
	<input type="text" class="form-control" id="name" placeholder="Subject Description" name="name" autocomplete="off">
	</div>
	</div><!-- /.box-body -->
