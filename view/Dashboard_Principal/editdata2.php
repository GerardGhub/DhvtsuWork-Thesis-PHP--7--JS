...
{
	$id = $_GET['edit_id'];
	$stmt_edit = $DB_con->prepare('SELECT * FROM mis WHERE item_id=:item_id');
...
if(isset($_POST['btn_save_updates']))
{
	...
	if(!isset($errMSG))
	{
		$stmt = $DB_con->prepare('UPDATE mis
		...
		$stmt->bindParam(':img_name',$itempic);
...
<table class="table table-bordered table-responsive">
	 ...
	 <tr>
		 ...
		 <td><input class="form-control" type="text" name="policy_title" value="<?php echo $policy_title; ?>" required readonly="readonly"/></td>
	 </tr>
	 
	  <tr>
		 <td><label class="control-label">Department</label></td>
		 <td><input id="inputprice" class="form-control" type="text" name="department" value="<?php echo $department; ?>" readonly="readonly"/></td>
	 </tr>
	 
		  <tr>
		 <td><label class="control-label">Issue Date</label></td>
		 <td><input id="inputprice" class="form-control" type="date" name="issuedate" value="<?php echo $issuedate; ?>" required readonly="readonly"/></td>
	 </tr>
		  <tr>
		 <td><label class="control-label">Effective Date</label></td>
		 <td><input id="inputprice" class="form-control" type="date" name="effectivedate" value="<?php echo $effectivedate; ?>"/></td>
	 </tr>
	 ...
	 <tr>
		 ...
		 <td>
			 <p><img class="img img-thumbnail" src="../item_images/<?php echo $img_name; ?>" height="150" width="610" /></p>
	 ...
	 <tr>
		 ...
		 <a class="btn btn-danger" href="managedata.php"> <span class="glyphicon glyphicon-backward"></span> Cancel </a>
