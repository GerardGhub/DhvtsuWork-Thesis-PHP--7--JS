                   	...
                   	<form role="form" action="../../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal">
                		<div class="box-body" >
                        	<div class="row">
                                ...
                                <div class="col-md-6">
                                <h4>Parent or Guardian Information</h4>
                                    <div class="form-group" id="divGIndexNumber">
                                     ...
                                     <div class="form-group" id="divGFullName">
                                        ...
                                        <div class="col-xs-9" id="divGFullName1">
                                           <input type="text" class="form-control" placeholder="Full Name" name="g_full_name" id="g_full_name" autocomplete="off">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGIName">
                                        ...
                                        <div class="col-xs-9" id="divGIName1">
                                            <input type="text" class="form-control" placeholder="Nick Name" name="g_i_name" id="g_i_name" autocomplete="off">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGAddress">
                                        ...
                                        <div class="col-xs-9" id="divGAddress1">
                                           <input type="text" class="form-control" placeholder="Address" name="g_address" id="g_address" autocomplete="off"> 
                                        </div>                    
                                    </div>
