...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-teacher"></i> Principal</a></li>
            		...
            		<div class="col-md-6">
                		<div class="panel">
        					<div class="panel-heading bg-primary">               
                    			...
                    			<h4 class="modal-title custom_align" id="Heading">Edit Principal</h4>
                			</div>
                			<form action="../../index.php" method="post" enctype="multipart/form-data" id="form2">
                                ...
                                <div class="panel-footer bg-gray-light">
                                    ...
                                    <input type="hidden" name="do" value="update_principal">
...
//MSK-00115 
	...
	var xhttp = new XMLHttpRequest();//MSK-00116-Ajax Start
    	...
    	xhttp.open("GET", "../../model/get_principal.php?id=" + Id , true);//MSK-00116-Ajax End											
  		xhttp.send();
    		...
    		if (this.readyState == 4 && this.status == 200){//MSK-000134
				...
				if(myArray[0]==1){//MSK-000135
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000136-Start Ajax  
						...
						// xhttp1.open("GET", "show_principal_table.php" , true);												
