        	...
        	<div class="col-md-7">
            	<div class="panel"><!--panel bg-maroon--> 
                	<div class="panel-heading bg-aqua-active">	
                    	<h4 class="panel-title" id="hname"> User Information of <?php echo $i_name; ?></h4>
                    </div>				
                    <div class="panel-body"><!--panel-body -->
                    	<div class="row" id="my_profile">
                			<div class="col-md-3"> 
                				<img id="photo2" alt="User Pic" src="../../<?php echo $image; ?>" class="rounded img-responsive"> 
                			</div>
                			<div class=" col-md-9"> 
                     ...
                     <div class="panel-footer text-right" id="panel_footer" >
                    	<a href="#" onClick="editMyProfile('<?php echo $index; ?>')" type="button" class="btn btn-sm btn-primary" id="btnEdit"><i class="glyphicon glyphicon-edit"></i>&nbsp;Edit</a><!--MSK-00151-->
...
function editMyProfile(my_index){
	...
	var xhttp = new XMLHttpRequest();//-Start Ajax  
		xhttp.onreadystatechange = function() {		
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				var xhttp1 = new XMLHttpRequest();//-Start Ajax  
