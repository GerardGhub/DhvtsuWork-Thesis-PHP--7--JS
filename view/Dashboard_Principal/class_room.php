  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="exampleModalLabel">Append Classroom
    ...
    <section class="content">
    	<div class="row"><!-- left column -->
            <div class="col-md-15"><!-- general form elements -->
						...
						<div class="box-body">
                			<div class="form-group" id="divName">
                    			<label for="">Classroom</label>
                      			<input type="text" class="form-control" id="name" placeholder="Classroom" name="name" autocomplete="off">                    
                    		</div>
                    		<div class="form-group" id="divStudentCount">
                      			<label for="">Total of Student</label>
                      			<input type="text" class="form-control" id="student_count" placeholder="Total of Student" name="student_count" autocomplete="off">
                    		</div>
                		</div><!-- /.box-body -->
