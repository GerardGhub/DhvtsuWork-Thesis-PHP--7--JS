...
header("Location: view/Dashboard_Principal/all_teacher.php?do=alert_from_salary_insert&msg=$msg&page=$page&teacher_id=$id&invoice_number=$invoice_number&desc='$status'&total_salary=$total&paid=$paid");//MSK-000143-5 
}
