...
if(isset($_POST["do"])&&($_POST["do"]=="update_principal")){
	...
	$sql1="SELECT * FROM principal where email='$email'";	
	...
	header("Location: view/Dashboard_Principal/all_principal.php?do=alert_from_update&msg=$msg&page=$c_page");//MSK-000143-U-23		
