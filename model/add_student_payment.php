...
if(isset($_POST["do"])&&($_POST["do"]=="add_student_payment")){
	...
	if(isset($_POST["showPage"])&&($_POST["showPage"]=="all_student")){
		header("Location:view/Dashboard_Principal/all_student.php?do=alert_from_payment_insert&msg=$msg&page=$page&index=$index&desc='$status'&monthly_fee=$monthly_fee&paid=$paid&invoice_number=$invoice_number&grade=$grade_id");
	}
	
	if(isset($_POST["showPage"])&&($_POST["showPage"]=="student_payment")){
		header("Location:view/Dashboard_Principal/student_payment.php?do=alert_from_payment_insert&msg=$msg&page=$page&index=$index&desc='$status'&monthly_fee=$monthly_fee&paid=$paid&invoice_number=$invoice_number&grade=$grade_id");
	}
