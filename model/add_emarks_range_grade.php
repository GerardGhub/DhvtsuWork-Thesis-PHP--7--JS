...
$msg=0;//for alerts
	...
	if($_POST["current_page"]== NULL){
		header("Location: view/Dashboard_Principal/grade.php?do=alert_from_insert&msg=$msg&grade=$grade_id");//MSK-000143-5
		
	}else{
		$page=$_POST["current_page"];
		header("Location: view/Dashboard_Principal/grade.php?do=alert_from_eMark_insert&msg=$msg&grade=$grade_id&page=$page");//MSK-000143-6
	}
